...
var ye = {
  ...
  backdropBrightness: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("brightness")), s),
  backdropContrast: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("contrast")), s),
  backdropGrayscale: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("grayscale")), s),
  backdropHueRotate: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("hueRotate")), k),
  backdropInvert: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("invert")), s),
  backdropOpacity: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("opacity")), s),
  backdropSaturate: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("saturate")), s),
  backdropSepia: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("sepia")), s),
  backgroundColor: ({
    theme: e
  }) => e("colors"),
  backgroundImage: {
  ...
  colors: () => __spreadValues({}, l),
  columns: __spreadValues({
    auto: "auto",
    1: "1",
    2: "2",
    3: "3",
  ...
  divideWidth: ({
    theme: e
  }) => __spreadValues(__spreadValues({}, e("borderWidth")), d),
  dropShadow: {
  ...
  flexGrow: __spreadValues({
    0: "0",
    DEFAULT: "1"
  }, l2),
  flexShrink: __spreadValues({
    0: "0",
    DEFAULT: "1"
  }, l2),
  fontFamily: {
  ...
  gradientColorStopPositions: __spreadValues({
    "0%": "0%",
    "5%": "5%",
    "10%": "10%",
    "15%": "15%",
  ...
  gridColumnStart: __spreadValues({
    auto: "auto",
    1: "1",
    2: "2",
    3: "3",
  ...
  gridTemplateColumns: __spreadValues({
    none: "none",
    subgrid: "subgrid",
  ...
  gridTemplateRows: __spreadValues({
    none: "none",
    subgrid: "subgrid",
    1: "repeat(1, minmax(0, 1fr))",
    2: "repeat(2, minmax(0, 1fr))",
  ...
  ringOffsetWidth: __spreadValues({
    0: "0px",
    1: "1px",
    2: "2px",
    4: "4px",
  ...
  textDecorationThickness: __spreadValues({
    auto: "auto",
    "from-font": "from-font",
    0: "0px",
    1: "1px",
  ...
  textUnderlineOffset: __spreadValues({
    auto: "auto",
    0: "0px",
    1: "1px",
    2: "2px",
  ...
  transitionDelay: __spreadValues({
    0: "0s",
    75: "75ms",
    100: "100ms",
    150: "150ms",
  ...
  transitionDuration: __spreadValues({
    DEFAULT: "150ms",
    0: "0s",
    75: "75ms",
    100: "100ms",
...
`);
  ...
  for (let f2 = 0; f2 < r.length; f2++) {
    ...
    if (g2 === Ce) l3 += r.slice(f2, f2 + 2), f2 += 1;
      ...
      if (g2 === ce) {
        ...
        u2 = l3.charCodeAt(l3.length - 1), u2 !== $e && u2 !== ce && u2 !== Ie && (l3 += " ");
      } else if (g2 === St && r.charCodeAt(f2 + 1) === St && l3.length === 0) {
        let m = "", h2 = f2, v2 = -1;
        ...
        } else if (v2 === -1 && u2 === Br) v2 = l3.length + A2 - h2;
        else if (u2 === Ue && m.length === 0) {
          l3 += r.slice(h2, A2), f2 = A2;
          break;
        } else if (u2 === ot) m += ")";
        else if (u2 === qr) m += "]";
        else if (u2 === Vt) m += "}";
        else if ((u2 === rt || r.length - 1 === A2) && m.length === 0) {
          f2 = A2 - 1, l3 += r.slice(h2, A2);
          break;
        ...
        o ? o.nodes.push(w2) : t.push(w2), l3 = "";
      } else if (g2 === Ue && l3.charCodeAt(0) === it) s2 = Ne(l3), o ? o.nodes.push(s2) : t.push(s2), l3 = "", s2 = null;
      else if (g2 === Ue && d2[d2.length - 1] !== ")") {
        let m = nt(l3);
        if (!m) throw l3.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${l3.trim()}\``);
        o ? o.nodes.push(m) : t.push(m), l3 = "";
      } else if (g2 === Vt && d2[d2.length - 1] !== ")") d2 += "}", s2 = W2(l3.trim()), o && o.nodes.push(s2), e.push(o), o = s2, l3 = "", s2 = null;
      else if (g2 === rt && d2[d2.length - 1] !== ")") {
        if (d2 === "") throw new Error("Missing opening {");
        if (d2 = d2.slice(0, -1), l3.length > 0) if (l3.charCodeAt(0) === it) s2 = Ne(l3), o ? o.nodes.push(s2) : t.push(s2), l3 = "", s2 = null;
        else {
          let h2 = l3.indexOf(":");
          if (o) {
            let v2 = nt(l3, h2);
            if (!v2) throw new Error(`Invalid declaration: \`${l3.trim()}\``);
            o.nodes.push(v2);
          }
        }
        let m = e.pop() ?? null;
        m === null && o && t.push(o), o = m, l3 = "", s2 = null;
      } else if (g2 === ot) d2 += ")", l3 += "(";
      else if (g2 === Tt) {
        if (d2[d2.length - 1] !== ")") throw new Error("Missing opening (");
        d2 = d2.slice(0, -1), l3 += ")";
      } else {
        if (l3.length === 0 && (g2 === $e || g2 === ce || g2 === Ie)) continue;
        l3 += String.fromCharCode(g2);
      }
    }
  }
  if (l3.charCodeAt(0) === it && t.push(Ne(l3)), d2.length > 0 && o) {
...
var ze = class {
  ...
  getOptions(t) {
    return t = pe2(this.#r(t)), this.values.get(t)?.options ?? 0;
  }
  entries() {
  ...
  markUsedVariable(t) {
    let i = pe2(this.#r(t)), e = this.values.get(i);
    if (!e) return false;
    let o = e.options & 16;
  ...
  resolve(t, i, e = 0) {
    ...
    return (e | s2.options) & 1 ? s2.value : this.#t(o);
  }
  resolveValue(t, i) {
    let e = this.#e(t, i);
  ...
  resolveWith(t, i, e = []) {
    ...
    for (let d2 of e) {
      ...
      f2 && (f2.options & 1 ? s2[d2] = f2.value : s2[d2] = this.#t(u2));
    }
    let l3 = this.values.get(o);
    return l3.options & 1 ? [l3.value, s2] : [this.#t(o), s2];
  }
  namespace(t) {
...
function X2(r, t, i = null) {
  for (let e = 0; e < r.length; e++) {
    let o = r[e], s2 = false, l3 = 0, d2 = t(o, {
      parent: i,
      replaceWith(u2) {
    ...
    if (d2 === 2) return 2;
    if (d2 !== 1 && o.kind === "function" && X2(o.nodes, t, o) === 2) return 2;
  }
}
function H2(r) {
  let t = "";
...
`);
  ...
  for (let l3 = 0; l3 < r.length; l3++) {
    ...
    switch (d2) {
      ...
      case Qr: {
        let u2 = l3;
        for (let f2 = l3 + 1; f2 < r.length; f2++) if (s2 = r.charCodeAt(f2), s2 === Kt) f2 += 1;
        else if (s2 === d2) {
          l3 = f2;
          break;
        }
...
function Le(r) {
  let t = [];
  return X2(G2(r), (i) => {
    if (!(i.kind !== "function" || i.value !== "var")) return X2(i.nodes, (e) => {
...
function W2(r, t = []) {
  return r.charCodeAt(0) === ri ? Ne(r, t) : F2(r, t);
}
...
function I2(r, t, i = [], e = {}) {
  for (let o = 0; o < r.length; o++) {
    ...
    if (s2.kind === "context") {
      if (I2(s2.nodes, t, i, __spreadValues(__spreadValues({}, e), s2.context)) === 2) return 2;
      continue;
    }
    i.push(s2);
    let d2 = false, u2 = 0, f2 = t(s2, {
      parent: l3,
      context: e,
      path: i,
      replaceWith(g2) {
...
function Me(r, t, i = [], e = {}) {
  for (let o = 0; o < r.length; o++) {
    ...
    if (s2.kind === "rule" || s2.kind === "at-rule") i.push(s2), Me(s2.nodes, t, i, e), i.pop();
      ...
      Me(s2.nodes, t, i, __spreadValues(__spreadValues({}, e), s2.context));
      continue;
    }
    i.push(s2), t(s2, {
      parent: l3,
...
function me(r, t, i = 3) {
  let e = [], o = /* @__PURE__ */ new Set(), s2 = new q2(() => /* @__PURE__ */ new Set()), l3 = /* @__PURE__ */ new Set(), d2 = /* @__PURE__ */ new Set(), u2 = [], f2 = [], g2 = new q2(() => /* @__PURE__ */ new Set());
    ...
    if (v2.kind === "declaration") {
      ...
      if (i & 2 && v2.value.includes("color-mix(")) {
        ...
        if (X2(k2, (S, {
          ...
          let S = __spreadProps(__spreadValues({}, v2), {
            value: H2(k2)
          }), O2 = W2("@supports (color: color-mix(in lab, red, red))", [v2]);
          w2.push(S, O2);
          return;
        }
      }
      ...
      if (v2.selector === "&") for (let k2 of v2.nodes) {
        let T2 = [];
        m(k2, T2, A2, b2 + 1), T2.length > 0 && w2.push(...T2);
      }
      else {
        let k2 = __spreadProps(__spreadValues({}, v2), {
          nodes: []
        });
      ...
      v2.name === "@keyframes" && (A2 = __spreadProps(__spreadValues({}, A2), {
        keyframes: true
      }));
      let k2 = __spreadProps(__spreadValues({}, v2), {
        nodes: []
      ...
      for (let T2 of v2.nodes) m(T2, k2.nodes, A2, b2 + 1);
      v2.name === "@keyframes" && A2.theme && l3.add(k2), (k2.nodes.length > 0 || k2.name === "@layer" || k2.name === "@charset" || k2.name === "@custom-media" || k2.name === "@namespace" || k2.name === "@import") && w2.push(k2);
      ...
      for (let k2 of v2.nodes) m(k2, w2, __spreadValues(__spreadValues({}, A2), v2.context), b2);
  ...
  for (let v2 of l3) if (!d2.has(v2.params)) {
    let w2 = e.indexOf(v2);
    e.splice(w2, 1);
  }
  if (h2 = h2.concat(e), i & 1) {
    let v2 = [];
    if (u2.length > 0 && v2.push(W2(":root, :host", u2)), f2.length > 0 && v2.push(W2("*, ::before, ::after, ::backdrop", f2)), v2.length > 0) {
      let w2 = h2.findIndex((A2) => !(A2.kind === "comment" || A2.kind === "at-rule" && (A2.name === "@charset" || A2.name === "@import")));
      h2.splice(w2 < 0 ? h2.length : w2, 0, U2("@layer", "properties", [])), h2.push(W2("@layer properties", [U2("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", v2)]));
    }
  }
  return h2;
}
...
function le(r) {
  if (r.indexOf("(") === -1) return ye2(r);
  let t = G2(r);
  return ut(t), r = H2(t), r = ie(r), r;
}
function ye2(r, t = false) {
  let i = "";
  for (let e = 0; e < r.length; e++) {
    let o = r[e];
...
function ut(r) {
  for (let t of r) switch (t.kind) {
    case "function": {
      ...
      if (t.value === "var" || t.value.endsWith("_var") || t.value === "theme" || t.value.endsWith("_theme")) {
        ...
        for (let i = 0; i < t.nodes.length; i++) {
          if (i == 0 && t.nodes[i].kind === "word") {
            t.nodes[i].value = ye2(t.nodes[i].value, true);
            continue;
          }
          ut([t.nodes[i]]);
        }
      ...
      t.value = ye2(t.value), ut(t.nodes);
      break;
    }
    case "separator":
    case "word": {
...
function* Gt(r, t) {
  ...
  let s2 = false;
  e[e.length - 1] === "!" ? (s2 = true, e = e.slice(0, -1)) : e[0] === "!" && (s2 = true, e = e.slice(1)), t.utilities.has(e, "static") && !e.includes("[") && (yield {
    kind: "static",
    root: e,
    variants: o,
    important: s2,
  ...
  if (l3[0] === "[") {
    ...
    let m = l3.charCodeAt(1);
    if (m !== Wt && !(m >= Bt && m <= qt)) return;
    l3 = l3.slice(1, -1);
    let h2 = l3.indexOf(":");
    if (h2 === -1 || h2 === 0 || h2 === l3.length - 1) return;
    let v2 = l3.slice(0, h2), w2 = le(l3.slice(h2 + 1));
    if (!se(w2)) return;
    yield {
      kind: "arbitrary",
      property: v2,
  ...
  if (l3[l3.length - 1] === "]") {
    ...
    let h2 = l3.slice(0, m);
    if (!t.utilities.has(h2, "functional")) return;
    let v2 = l3.slice(m + 2, -1), w2 = g(v2, ":"), A2 = null;
    if (w2.length === 2 && (A2 = w2[0], v2 = w2[1]), v2[0] !== "-" && v2[1] !== "-") return;
    g2 = [[h2, A2 === null ? `[var(${v2})]` : `[${A2}:var(${v2})]`]];
  } else g2 = Yt(l3, (m) => t.utilities.has(m, "functional"));
  for (let [m, h2] of g2) {
    let v2 = {
      kind: "functional",
      root: m,
    ...
    }
    {
      ...
      if (w2 !== -1) {
        ...
        let b2 = d2 === null || v2.modifier?.kind === "arbitrary" ? null : `${h2}/${d2}`;
        v2.value = {
          kind: "named",
          value: h2,
          fraction: b2
...
function ct(r) {
  ...
  if (r[0] === "(" && r[r.length - 1] === ")") {
    let t = le(r.slice(1, -1));
    return !se(t) || t.length === 0 || t.trim().length === 0 || t[0] !== "-" && t[1] !== "-" ? null : {
      kind: "arbitrary",
      value: `var(${t})`
    };
  }
...
function Jt(r, t) {
  ...
  }
  {
    let [i, e = null, o] = g(r, "/");
    if (o) return null;
    let s2 = Yt(i, (l3) => t.variants.has(l3));
    for (let [l3, d2] of s2) switch (t.variants.kind(l3)) {
      case "static":
        return d2 !== null || e !== null ? null : {
          kind: "static",
          root: l3
        };
      case "functional": {
        ...
        if (d2[d2.length - 1] === "]") {
          ...
          return !se(f2) || f2.length === 0 || f2.trim().length === 0 ? null : {
            kind: "functional",
            root: l3,
            modifier: u2,
            value: {
        ...
        if (d2[d2.length - 1] === ")") {
          if (d2[0] !== "(") continue;
          let f2 = le(d2.slice(1, -1));
          return !se(f2) || f2.length === 0 || f2.trim().length === 0 || f2[0] !== "-" && f2[1] !== "-" ? null : {
            kind: "functional",
            root: l3,
            modifier: u2,
            value: {
...
function Ve(r, t) {
  return g(r, ",").map((e) => {
    e = e.trim();
    let o = g(e, " ").filter((f2) => f2.trim() !== ""), s2 = null, l3 = null, d2 = null;
    for (let f2 of o) ai.has(f2) || (Ht.test(f2) ? (l3 === null ? l3 = f2 : d2 === null && (d2 = f2), Ht.lastIndex = 0) : s2 === null && (s2 = f2));
...
var qe = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"];
var dt = class {
  utilities = new q2(() => []);
...
function C2(r, t, i) {
  return U2("@property", r, [a("syntax", i ? `"${i}"` : '"*"'), a("inherits", "false"), ...t ? [a("initial-value", t)] : []]);
}
function Y2(r, t) {
  if (t === null) return r;
  let i = Number(t);
...
function Z2(r, t, i) {
  if (!t) return r;
  if (t.kind === "arbitrary") return Y2(r, t.value);
  let e = i.resolve(t.value, ["--opacity"]);
  return e ? Y2(r, e) : de(t.value) ? Y2(r, `${t.value}%`) : null;
}
function Q2(r, t, i) {
  let e = null;
...
function Xt(r) {
  ...
  function i(n, c) {
    ...
    t.suggest(n, () => {
      ...
      for (let K2 of c()) {
        ...
        K2.supportsFractions && N2.push(...y2), K2.hasDefaultValue && N2.unshift(null), $2.push({
          supportsNegative: K2.supportsNegative,
          values: N2,
          modifiers: V2
        });
      }
  ...
  function o(n, c) {
        ...
        if (y2.value) {
          if (y2.value.kind === "arbitrary") {
            ...
            if ($2 === null && x && c.handleNegativeBareValue) {
              if ($2 = c.handleNegativeBareValue(y2.value), !$2?.includes("/") && y2.modifier) return;
              if ($2 !== null) return c.handle($2, null);
            }
            if ($2 === null && c.handleBareValue && ($2 = c.handleBareValue(y2.value), !$2?.includes("/") && y2.modifier)) return;
          }
        } else {
          if (y2.modifier) return;
    ...
    c.supportsNegative && t.functional(`-${n}`, p2({
      negative: true
    })), t.functional(n, p2({
      negative: false
    })), i(n, () => [{
  ...
  function s2(n, c) {
    t.functional(n, (p2) => {
      if (!p2.value) return;
      let x = null;
      if (p2.value.kind === "arbitrary" ? (x = p2.value.value, x = Z2(x, p2.modifier, r)) : x = Q2(p2, r, c.themeKeys), x !== null) return c.handle(x);
    }), i(n, () => [{
  ...
  function l3(n, c, p2, {
    supportsNegative: x = false,
    supportsFractions: y2 = false
  } = {}) {
    x && t.static(`-${n}-px`, () => p2("-1px")), t.static(`${n}-px`, () => p2("1px")), o(n, {
      themeKeys: c,
      supportsFractions: y2,
      supportsNegative: x,
      defaultValue: null,
      handleBareValue: ({
        value: $2
  ...
  for (let [n, c] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${n}-auto`, [[c, "auto"]]), e(`${n}-full`, [[c, "100%"]]), e(`-${n}-full`, [[c, "-100%"]]), l3(n, ["--inset", "--spacing"], (p2) => [a(c, p2)], {
    supportsNegative: true,
    supportsFractions: true
  });
  e("isolate", [["isolation", "isolate"]]), e("isolation-auto", [["isolation", "auto"]]), e("z-auto", [["z-index", "auto"]]), o("z", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--z-index"],
    handle: (n) => [a("z-index", n)]
  }), i("z", () => [{
    supportsNegative: true,
    values: ["0", "10", "20", "30", "40", "50"],
    valueThemeKeys: ["--z-index"]
  }]), e("order-first", [["order", "-9999"]]), e("order-last", [["order", "9999"]]), e("order-none", [["order", "0"]]), o("order", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
  ...
  }]), e("col-auto", [["grid-column", "auto"]]), o("col", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-column"],
    handle: (n) => [a("grid-column", n)]
  }), e("col-span-full", [["grid-column", "1 / -1"]]), o("col-span", {
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    handle: (n) => [a("grid-column", `span ${n} / span ${n}`)]
  }), e("col-start-auto", [["grid-column-start", "auto"]]), o("col-start", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-column-start"],
    handle: (n) => [a("grid-column-start", n)]
  }), e("col-end-auto", [["grid-column-end", "auto"]]), o("col-end", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-column-end"],
    handle: (n) => [a("grid-column-end", n)]
  }), i("col-span", () => [{
    values: Array.from({
      length: 12
    }, (n, c) => `${c + 1}`),
  ...
  }]), e("row-auto", [["grid-row", "auto"]]), o("row", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-row"],
    handle: (n) => [a("grid-row", n)]
  }), e("row-span-full", [["grid-row", "1 / -1"]]), o("row-span", {
    themeKeys: [],
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    handle: (n) => [a("grid-row", `span ${n} / span ${n}`)]
  }), e("row-start-auto", [["grid-row-start", "auto"]]), o("row-start", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-row-start"],
    handle: (n) => [a("grid-row-start", n)]
  }), e("row-end-auto", [["grid-row-end", "auto"]]), o("row-end", {
    supportsNegative: true,
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    themeKeys: ["--grid-row-end"],
    handle: (n) => [a("grid-row-end", n)]
  }), i("row-span", () => [{
    values: Array.from({
      length: 12
    }, (n, c) => `${c + 1}`),
  ...
  for (let [n, c] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${n}-auto`, [[c, "auto"]]), l3(n, ["--margin", "--spacing"], (p2) => [a(c, p2)], {
    supportsNegative: true
  });
  e("box-border", [["box-sizing", "border-box"]]), e("box-content", [["box-sizing", "content-box"]]), e("line-clamp-none", [["overflow", "visible"], ["display", "block"], ["-webkit-box-orient", "horizontal"], ["-webkit-line-clamp", "unset"]]), o("line-clamp", {
    themeKeys: ["--line-clamp"],
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    handle: (n) => [a("overflow", "hidden"), a("display", "-webkit-box"), a("-webkit-box-orient", "vertical"), a("-webkit-line-clamp", n)]
  }), i("line-clamp", () => [{
    values: ["1", "2", "3", "4", "5", "6"],
    valueThemeKeys: ["--line-clamp"]
  }]), e("block", [["display", "block"]]), e("inline-block", [["display", "inline-block"]]), e("inline", [["display", "inline"]]), e("hidden", [["display", "none"]]), e("inline-flex", [["display", "inline-flex"]]), e("table", [["display", "table"]]), e("inline-table", [["display", "inline-table"]]), e("table-caption", [["display", "table-caption"]]), e("table-cell", [["display", "table-cell"]]), e("table-column", [["display", "table-column"]]), e("table-column-group", [["display", "table-column-group"]]), e("table-footer-group", [["display", "table-footer-group"]]), e("table-header-group", [["display", "table-header-group"]]), e("table-row-group", [["display", "table-row-group"]]), e("table-row", [["display", "table-row"]]), e("flow-root", [["display", "flow-root"]]), e("flex", [["display", "flex"]]), e("grid", [["display", "grid"]]), e("inline-grid", [["display", "inline-grid"]]), e("contents", [["display", "contents"]]), e("list-item", [["display", "list-item"]]), e("field-sizing-content", [["field-sizing", "content"]]), e("field-sizing-fixed", [["field-sizing", "fixed"]]), e("aspect-auto", [["aspect-ratio", "auto"]]), e("aspect-square", [["aspect-ratio", "1 / 1"]]), o("aspect", {
    themeKeys: ["--aspect"],
    handleBareValue: ({
      fraction: n
    }) => {
  ...
  e("w-screen", [["width", "100vw"]]), e("min-w-screen", [["min-width", "100vw"]]), e("max-w-screen", [["max-width", "100vw"]]), e("h-screen", [["height", "100vh"]]), e("min-h-screen", [["min-height", "100vh"]]), e("max-h-screen", [["max-height", "100vh"]]), e("max-w-none", [["max-width", "none"]]), e("max-h-none", [["max-height", "none"]]), l3("size", ["--size", "--spacing"], (n) => [a("--tw-sort", "size"), a("width", n), a("height", n)], {
    supportsFractions: true
  });
  for (let [n, c, p2] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) l3(n, c, (x) => [a(p2, x)], {
    supportsFractions: true
  });
  t.static("container", () => {
    let n = [...r.namespace("--breakpoint").values()];
    n.sort((p2, x) => ge2(p2, x, "asc"));
    let c = [a("--tw-sort", "--tw-container-component"), a("width", "100%")];
    for (let p2 of n) c.push(U2("@media", `(width >= ${p2})`, [a("max-width", p2)]));
    return c;
    ...
    if (n.value) {
      ...
      if (n.value.fraction) {
        let [c, p2] = g(n.value.fraction, "/");
        return !p(c) || !p(p2) ? void 0 : [a("flex", `calc(${n.value.fraction} * 100%)`)];
      }
    ...
    handle: (n) => [a("flex-shrink", n)]
  }), o("grow", {
    defaultValue: "1",
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    handle: (n) => [a("flex-grow", n)]
  }), i("shrink", () => [{
    values: ["0"],
    valueThemeKeys: [],
    ...
    valueThemeKeys: [],
    hasDefaultValue: true
  }]), e("basis-auto", [["flex-basis", "auto"]]), e("basis-full", [["flex-basis", "100%"]]), l3("basis", ["--flex-basis", "--spacing", "--container"], (n) => [a("flex-basis", n)], {
    supportsFractions: true
  }), e("table-auto", [["table-layout", "auto"]]), e("table-fixed", [["table-layout", "fixed"]]), e("caption-top", [["caption-side", "top"]]), e("caption-bottom", [["caption-side", "bottom"]]), e("border-collapse", [["border-collapse", "collapse"]]), e("border-separate", [["border-collapse", "separate"]]);
  let d2 = () => D2([C2("--tw-border-spacing-x", "0", "<length>"), C2("--tw-border-spacing-y", "0", "<length>")]);
  l3("border-spacing", ["--border-spacing", "--spacing"], (n) => [d2(), a("--tw-border-spacing-x", n), a("--tw-border-spacing-y", n), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]), l3("border-spacing-x", ["--border-spacing", "--spacing"], (n) => [d2(), a("--tw-border-spacing-x", n), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]), l3("border-spacing-y", ["--border-spacing", "--spacing"], (n) => [d2(), a("--tw-border-spacing-y", n), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]), e("origin-center", [["transform-origin", "center"]]), e("origin-top", [["transform-origin", "top"]]), e("origin-top-right", [["transform-origin", "top right"]]), e("origin-right", [["transform-origin", "right"]]), e("origin-bottom-right", [["transform-origin", "bottom right"]]), e("origin-bottom", [["transform-origin", "bottom"]]), e("origin-bottom-left", [["transform-origin", "bottom left"]]), e("origin-left", [["transform-origin", "left"]]), e("origin-top-left", [["transform-origin", "top left"]]), o("origin", {
    ...
    handle: (n) => [a("perspective-origin", n)]
  }), e("perspective-none", [["perspective", "none"]]), o("perspective", {
    themeKeys: ["--perspective"],
    handle: (n) => [a("perspective", n)]
  });
  let u2 = () => D2([C2("--tw-translate-x", "0"), C2("--tw-translate-y", "0"), C2("--tw-translate-z", "0")]);
  e("translate-none", [["translate", "none"]]), e("-translate-full", [u2, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e("translate-full", [u2, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), l3("translate", ["--translate", "--spacing"], (n) => [u2(), a("--tw-translate-x", n), a("--tw-translate-y", n), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
    supportsNegative: true,
    supportsFractions: true
  });
  for (let n of ["x", "y"]) e(`-translate-${n}-full`, [u2, [`--tw-translate-${n}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${n}-full`, [u2, [`--tw-translate-${n}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), l3(`translate-${n}`, ["--translate", "--spacing"], (c) => [u2(), a(`--tw-translate-${n}`, c), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
    supportsNegative: true,
    supportsFractions: true
  });
  l3("translate-z", ["--translate", "--spacing"], (n) => [u2(), a("--tw-translate-z", n), a("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")], {
    supportsNegative: true
  }), e("translate-3d", [u2, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
  let f2 = () => D2([C2("--tw-scale-x", "1"), C2("--tw-scale-y", "1"), C2("--tw-scale-z", "1")]);
  ...
  function g2({
    ...
    return (c) => {
      ...
      let p2;
      return c.value.kind === "arbitrary" ? (p2 = c.value.value, [a("scale", p2)]) : (p2 = r.resolve(c.value.value, ["--scale"]), !p2 && p(c.value.value) && (p2 = `${c.value.value}%`), p2 ? (p2 = n ? `calc(${p2} * -1)` : p2, [f2(), a("--tw-scale-x", p2), a("--tw-scale-y", p2), a("--tw-scale-z", p2), a("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0);
    };
  }
  t.functional("-scale", g2({
    negative: true
  })), t.functional("scale", g2({
    negative: false
  })), i("scale", () => [{
  ...
  for (let n of ["x", "y", "z"]) o(`scale-${n}`, {
    supportsNegative: true,
    themeKeys: ["--scale"],
    handleBareValue: ({
      value: c
    }) => p(c) ? `${c}%` : null,
    handle: (c) => [f2(), a(`--tw-scale-${n}`, c), a("scale", `var(--tw-scale-x) var(--tw-scale-y)${n === "z" ? " var(--tw-scale-z)" : ""}`)]
  }), i(`scale-${n}`, () => [{
    supportsNegative: true,
    values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
    valueThemeKeys: ["--scale"]
  ...
  function m({
    ...
    return (c) => {
      ...
      if (c.value.kind === "arbitrary") {
        p2 = c.value.value;
        let x = c.value.dataType ?? pe(p2, ["angle", "vector"]);
        if (x === "vector") return [a("rotate", `${p2} var(--tw-rotate)`)];
        if (x !== "angle") return [a("rotate", p2)];
      } else if (p2 = r.resolve(c.value.value, ["--rotate"]), !p2 && p(c.value.value) && (p2 = `${c.value.value}deg`), !p2) return;
  ...
  {
    let n = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" "), c = () => D2([C2("--tw-rotate-x", "rotateX(0)"), C2("--tw-rotate-y", "rotateY(0)"), C2("--tw-rotate-z", "rotateZ(0)"), C2("--tw-skew-x", "skewX(0)"), C2("--tw-skew-y", "skewY(0)")]);
    for (let p2 of ["x", "y", "z"]) o(`rotate-${p2}`, {
      supportsNegative: true,
      themeKeys: ["--rotate"],
      handleBareValue: ({
        value: x
      }) => p(x) ? `${x}deg` : null,
      handle: (x) => [c(), a(`--tw-rotate-${p2}`, `rotate${p2.toUpperCase()}(${x})`), a("transform", n)]
    }), i(`rotate-${p2}`, () => [{
      supportsNegative: true,
      values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"],
      valueThemeKeys: ["--rotate"]
    ...
    o("skew", {
      ...
      handle: (p2) => [c(), a("--tw-skew-x", `skewX(${p2})`), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)]
    }), o("skew-x", {
      supportsNegative: true,
      themeKeys: ["--skew"],
      handleBareValue: ({
      ...
      handle: (p2) => [c(), a("--tw-skew-x", `skewX(${p2})`), a("transform", n)]
    }), o("skew-y", {
      supportsNegative: true,
      themeKeys: ["--skew"],
      handleBareValue: ({
      ...
      handle: (p2) => [c(), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)]
    }), i("skew", () => [{
      supportsNegative: true,
      values: ["0", "1", "2", "3", "6", "12"],
      valueThemeKeys: ["--skew"]
      ...
      values: ["0", "1", "2", "3", "6", "12"],
      valueThemeKeys: ["--skew"]
    }]), t.functional("transform", (p2) => {
      if (p2.modifier) return;
      let x = null;
      if (p2.value ? p2.value.kind === "arbitrary" && (x = p2.value.value) : x = n, x !== null) return [c(), a("transform", x)];
    }), i("transform", () => [{
      hasDefaultValue: true
    }]), e("transform-cpu", [["transform", n]]), e("transform-gpu", [["transform", `translateZ(0) ${n}`]]), e("transform-none", [["transform", "none"]]);
  }
  ...
  let h2 = () => D2([C2("--tw-pan-x"), C2("--tw-pan-y"), C2("--tw-pinch-zoom")]);
  ...
  let v2 = () => D2([C2("--tw-scroll-snap-strictness", "proximity", "*")]);
  ...
  e("list-inside", [["list-style-position", "inside"]]), e("list-outside", [["list-style-position", "outside"]]), e("list-none", [["list-style-type", "none"]]), e("list-disc", [["list-style-type", "disc"]]), e("list-decimal", [["list-style-type", "decimal"]]), o("list", {
    themeKeys: ["--list-style-type"],
    handle: (n) => [a("list-style-type", n)]
  }), e("list-image-none", [["list-style-image", "none"]]), o("list-image", {
    themeKeys: ["--list-style-image"],
    handle: (n) => [a("list-style-image", n)]
  }), e("appearance-none", [["appearance", "none"]]), e("appearance-auto", [["appearance", "auto"]]), e("scheme-normal", [["color-scheme", "normal"]]), e("scheme-dark", [["color-scheme", "dark"]]), e("scheme-light", [["color-scheme", "light"]]), e("scheme-light-dark", [["color-scheme", "light dark"]]), e("scheme-only-dark", [["color-scheme", "only dark"]]), e("scheme-only-light", [["color-scheme", "only light"]]), e("columns-auto", [["columns", "auto"]]), o("columns", {
    themeKeys: ["--columns", "--container"],
    handleBareValue: ({
      value: n
    }) => p(n) ? n : null,
    handle: (n) => [a("columns", n)]
  }), i("columns", () => [{
    values: Array.from({
      length: 12
    }, (n, c) => `${c + 1}`),
  ...
  e("grid-flow-row", [["grid-auto-flow", "row"]]), e("grid-flow-col", [["grid-auto-flow", "column"]]), e("grid-flow-dense", [["grid-auto-flow", "dense"]]), e("grid-flow-row-dense", [["grid-auto-flow", "row dense"]]), e("grid-flow-col-dense", [["grid-auto-flow", "column dense"]]), e("auto-cols-auto", [["grid-auto-columns", "auto"]]), e("auto-cols-min", [["grid-auto-columns", "min-content"]]), e("auto-cols-max", [["grid-auto-columns", "max-content"]]), e("auto-cols-fr", [["grid-auto-columns", "minmax(0, 1fr)"]]), o("auto-cols", {
    themeKeys: ["--grid-auto-columns"],
    handle: (n) => [a("grid-auto-columns", n)]
  }), e("auto-rows-auto", [["grid-auto-rows", "auto"]]), e("auto-rows-min", [["grid-auto-rows", "min-content"]]), e("auto-rows-max", [["grid-auto-rows", "max-content"]]), e("auto-rows-fr", [["grid-auto-rows", "minmax(0, 1fr)"]]), o("auto-rows", {
    themeKeys: ["--grid-auto-rows"],
    handle: (n) => [a("grid-auto-rows", n)]
  }), e("grid-cols-none", [["grid-template-columns", "none"]]), e("grid-cols-subgrid", [["grid-template-columns", "subgrid"]]), o("grid-cols", {
    themeKeys: ["--grid-template-columns"],
    handleBareValue: ({
      value: n
    }) => ge(n) ? `repeat(${n}, minmax(0, 1fr))` : null,
    handle: (n) => [a("grid-template-columns", n)]
  }), e("grid-rows-none", [["grid-template-rows", "none"]]), e("grid-rows-subgrid", [["grid-template-rows", "subgrid"]]), o("grid-rows", {
    themeKeys: ["--grid-template-rows"],
    handleBareValue: ({
      value: n
    }) => ge(n) ? `repeat(${n}, minmax(0, 1fr))` : null,
    handle: (n) => [a("grid-template-rows", n)]
  }), i("grid-cols", () => [{
    values: Array.from({
      length: 12
    }, (n, c) => `${c + 1}`),
  ...
  e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
  {
    let c = function(p2, x) {
      t.functional(p2, (y2) => {
        ...
        if (y2.value.kind === "arbitrary") {
          ...
          switch (y2.value.dataType ?? pe($2, ["color", "line-width", "length"])) {
            case "line-width":
            case "length": {
              if (y2.modifier) return;
              let N2 = x.width($2);
            ...
            default:
              return $2 = Z2($2, y2.modifier, r), $2 === null ? void 0 : x.color($2);
          }
        }
        {
          let $2 = Q2(y2, r, ["--border-color", "--color"]);
    ...
    var J2 = c;
    let n = () => D2([C2("--tw-border-style", "solid")]);
    c("border", {
      width: (p2) => [a("border-style", "var(--tw-border-style)"), a("border-width", p2)],
      color: (p2) => [a("border-color", p2)]
    }), c("border-x", {
      width: (p2) => [a("border-inline-style", "var(--tw-border-style)"), a("border-inline-width", p2)],
      color: (p2) => [a("border-inline-color", p2)]
    }), c("border-y", {
      width: (p2) => [a("border-block-style", "var(--tw-border-style)"), a("border-block-width", p2)],
      color: (p2) => [a("border-block-color", p2)]
    }), c("border-s", {
      width: (p2) => [a("border-inline-start-style", "var(--tw-border-style)"), a("border-inline-start-width", p2)],
      color: (p2) => [a("border-inline-start-color", p2)]
    }), c("border-e", {
      width: (p2) => [a("border-inline-end-style", "var(--tw-border-style)"), a("border-inline-end-width", p2)],
      color: (p2) => [a("border-inline-end-color", p2)]
    }), c("border-t", {
      width: (p2) => [a("border-top-style", "var(--tw-border-style)"), a("border-top-width", p2)],
      color: (p2) => [a("border-top-color", p2)]
    }), c("border-r", {
      width: (p2) => [a("border-right-style", "var(--tw-border-style)"), a("border-right-width", p2)],
      color: (p2) => [a("border-right-color", p2)]
    }), c("border-b", {
      width: (p2) => [a("border-bottom-style", "var(--tw-border-style)"), a("border-bottom-width", p2)],
      color: (p2) => [a("border-bottom-color", p2)]
    }), c("border-l", {
      width: (p2) => [a("border-left-style", "var(--tw-border-style)"), a("border-left-width", p2)],
      color: (p2) => [a("border-left-color", p2)]
    }), o("divide-x", {
      ...
      handle: (p2) => [D2([C2("--tw-divide-x-reverse", "0")]), F2(":where(& > :not(:last-child))", [a("--tw-sort", "divide-x-width"), n(), a("--tw-divide-x-reverse", "0"), a("border-inline-style", "var(--tw-border-style)"), a("border-inline-start-width", `calc(${p2} * var(--tw-divide-x-reverse))`), a("border-inline-end-width", `calc(${p2} * calc(1 - var(--tw-divide-x-reverse)))`)])]
    }), o("divide-y", {
      defaultValue: r.get(["--default-border-width"]) ?? "1px",
      themeKeys: ["--divide-width", "--border-width"],
      handleBareValue: ({
      ...
      handle: (p2) => [D2([C2("--tw-divide-y-reverse", "0")]), F2(":where(& > :not(:last-child))", [a("--tw-sort", "divide-y-width"), n(), a("--tw-divide-y-reverse", "0"), a("border-bottom-style", "var(--tw-border-style)"), a("border-top-style", "var(--tw-border-style)"), a("border-top-width", `calc(${p2} * var(--tw-divide-y-reverse))`), a("border-bottom-width", `calc(${p2} * calc(1 - var(--tw-divide-y-reverse)))`)])]
    }), i("divide-x", () => [{
      values: ["0", "2", "4", "8"],
      ...
      valueThemeKeys: ["--divide-width", "--border-width"],
      hasDefaultValue: true
    }]), e("divide-x-reverse", [() => D2([C2("--tw-divide-x-reverse", "0")]), () => F2(":where(& > :not(:last-child))", [a("--tw-divide-x-reverse", "1")])]), e("divide-y-reverse", [() => D2([C2("--tw-divide-y-reverse", "0")]), () => F2(":where(& > :not(:last-child))", [a("--tw-divide-y-reverse", "1")])]);
    for (let p2 of ["solid", "dashed", "dotted", "double", "none"]) e(`divide-${p2}`, [() => F2(":where(& > :not(:last-child))", [a("--tw-sort", "divide-style"), a("--tw-border-style", p2), a("border-style", p2)])]);
  }
  e("bg-auto", [["background-size", "auto"]]), e("bg-cover", [["background-size", "cover"]]), e("bg-contain", [["background-size", "contain"]]), o("bg-size", {
    handle(n) {
  ...
  }), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let p2 = function($2) {
      ...
      return (K2) => {
        ...
        let V2 = p2(K2.modifier);
        return [a("--tw-gradient-position", `${N2}`), W2("@supports (background-image: linear-gradient(in lab, red, red))", [a("--tw-gradient-position", `${N2} ${V2}`)]), a("background-image", "linear-gradient(var(--tw-gradient-stops))")];
      };
    }, y2 = function({
      negative: $2
    }) {
    ...
    t.functional("-bg-linear", x({
      ...
      supportsNegative: true,
      modifiers: n
    }]), t.functional("bg-radial", ($2) => {
      if (!$2.value) {
        let K2 = p2($2.modifier);
  ...
  t.functional("bg", (n) => {
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
        switch (n.value.dataType ?? pe(c, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
          case "percentage":
          case "position":
          ...
          default:
            return c = Z2(c, n.modifier, r), c === null ? void 0 : [a("background-color", c)];
        }
      }
      {
        let c = Q2(n, r, ["--background-color", "--color"]);
  ...
  let w2 = () => D2([C2("--tw-gradient-position"), C2("--tw-gradient-from", "#0000", "<color>"), C2("--tw-gradient-via", "#0000", "<color>"), C2("--tw-gradient-to", "#0000", "<color>"), C2("--tw-gradient-stops"), C2("--tw-gradient-via-stops"), C2("--tw-gradient-from-position", "0%", "<length-percentage>"), C2("--tw-gradient-via-position", "50%", "<length-percentage>"), C2("--tw-gradient-to-position", "100%", "<length-percentage>")]);
  function A2(n, c) {
    t.functional(n, (p2) => {
      if (p2.value) {
        if (p2.value.kind === "arbitrary") {
          ...
          switch (p2.value.dataType ?? pe(x, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return p2.modifier ? void 0 : c.position(x);
            default:
              return x = Z2(x, p2.modifier, r), x === null ? void 0 : c.color(x);
          }
        }
        {
        ...
        }
        {
          ...
          if (p2.value.value[p2.value.value.length - 1] === "%" && p(p2.value.value.slice(0, -1))) return c.position(p2.value.value);
        }
      }
    }), i(n, () => [{
      values: ["current", "inherit", "transparent"],
  ...
  A2("from", {
    color: (n) => [w2(), a("--tw-sort", "--tw-gradient-from"), a("--tw-gradient-from", n), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
    position: (n) => [w2(), a("--tw-gradient-from-position", n)]
  }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), A2("via", {
    color: (n) => [w2(), a("--tw-sort", "--tw-gradient-via"), a("--tw-gradient-via", n), a("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), a("--tw-gradient-stops", "var(--tw-gradient-via-stops)")],
    position: (n) => [w2(), a("--tw-gradient-via-position", n)]
  }), A2("to", {
    color: (n) => [w2(), a("--tw-sort", "--tw-gradient-to"), a("--tw-gradient-to", n), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
    position: (n) => [w2(), a("--tw-gradient-to-position", n)]
  }), e("mask-none", [["mask-image", "none"]]), t.functional("mask", (n) => {
    if (!n.value || n.modifier || n.value.kind !== "arbitrary") return;
    let c = n.value.value;
    switch (n.value.dataType ?? pe(c, ["image", "percentage", "position", "bg-size", "length", "url"])) {
      case "percentage":
      case "position":
  ...
  let b2 = () => D2([C2("--tw-mask-linear", "linear-gradient(#fff, #fff)"), C2("--tw-mask-radial", "linear-gradient(#fff, #fff)"), C2("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
  function k2(n, c) {
    t.functional(n, (p2) => {
      if (p2.value) {
        if (p2.value.kind === "arbitrary") {
          ...
          switch (p2.value.dataType ?? pe(x, ["length", "percentage", "color"])) {
            case "color":
              return x = Z2(x, p2.modifier, r), x === null ? void 0 : c.color(x);
            case "percentage":
              return p2.modifier || !p(x.slice(0, -1)) ? void 0 : c.position(x);
            default:
              return p2.modifier ? void 0 : c.position(x);
          }
        }
        ...
        }
        {
          ...
          switch (x) {
            case "number": {
              ...
              return !y2 || !ue(p2.value.value) ? void 0 : c.position(`calc(${y2} * ${p2.value.value})`);
            }
            case "percentage":
              return p(p2.value.value.slice(0, -1)) ? c.position(p2.value.value) : void 0;
            default:
              return;
          }
        }
  ...
  let T2 = () => D2([C2("--tw-mask-left", "linear-gradient(#fff, #fff)"), C2("--tw-mask-right", "linear-gradient(#fff, #fff)"), C2("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), C2("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
  function S(n, c, p2) {
    k2(n, {
      color(x) {
        ...
        for (let $2 of ["top", "right", "bottom", "left"]) p2[$2] && (y2.push(a(`--tw-mask-${$2}`, `linear-gradient(to ${$2}, var(--tw-mask-${$2}-from-color) var(--tw-mask-${$2}-from-position), var(--tw-mask-${$2}-to-color) var(--tw-mask-${$2}-to-position))`)), y2.push(D2([C2(`--tw-mask-${$2}-from-position`, "0%"), C2(`--tw-mask-${$2}-to-position`, "100%"), C2(`--tw-mask-${$2}-from-color`, "black"), C2(`--tw-mask-${$2}-to-color`, "transparent")])), y2.push(a(`--tw-mask-${$2}-${c}-color`, x)));
        return y2;
      },
      position(x) {
        let y2 = [b2(), T2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
  ...
  let O2 = () => D2([C2("--tw-mask-linear-position", "0deg"), C2("--tw-mask-linear-from-position", "0%"), C2("--tw-mask-linear-to-position", "100%"), C2("--tw-mask-linear-from-color", "black"), C2("--tw-mask-linear-to-color", "transparent")]);
  o("mask-linear", {
    defaultValue: null,
    supportsNegative: true,
    ...
    handle: (n) => [b2(), O2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))"), a("--tw-mask-linear-position", n)]
  }), i("mask-linear", () => [{
    supportsNegative: true,
    values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
  }]), k2("mask-linear-from", {
    color: (n) => [b2(), O2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), a("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), a("--tw-mask-linear-from-color", n)],
    position: (n) => [b2(), O2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), a("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), a("--tw-mask-linear-from-position", n)]
  }), k2("mask-linear-to", {
    color: (n) => [b2(), O2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), a("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), a("--tw-mask-linear-to-color", n)],
  ...
  let P2 = () => D2([C2("--tw-mask-radial-from-position", "0%"), C2("--tw-mask-radial-to-position", "100%"), C2("--tw-mask-radial-from-color", "black"), C2("--tw-mask-radial-to-color", "transparent"), C2("--tw-mask-radial-shape", "ellipse"), C2("--tw-mask-radial-size", "farthest-corner"), C2("--tw-mask-radial-position", "center")]);
  e("mask-circle", [["--tw-mask-radial-shape", "circle"]]), e("mask-ellipse", [["--tw-mask-radial-shape", "ellipse"]]), e("mask-radial-closest-side", [["--tw-mask-radial-size", "closest-side"]]), e("mask-radial-farthest-side", [["--tw-mask-radial-size", "farthest-side"]]), e("mask-radial-closest-corner", [["--tw-mask-radial-size", "closest-corner"]]), e("mask-radial-farthest-corner", [["--tw-mask-radial-size", "farthest-corner"]]), e("mask-radial-at-top", [["--tw-mask-radial-position", "top"]]), e("mask-radial-at-top-left", [["--tw-mask-radial-position", "top left"]]), e("mask-radial-at-top-right", [["--tw-mask-radial-position", "top right"]]), e("mask-radial-at-bottom", [["--tw-mask-radial-position", "bottom"]]), e("mask-radial-at-bottom-left", [["--tw-mask-radial-position", "bottom left"]]), e("mask-radial-at-bottom-right", [["--tw-mask-radial-position", "bottom right"]]), e("mask-radial-at-left", [["--tw-mask-radial-position", "left"]]), e("mask-radial-at-right", [["--tw-mask-radial-position", "right"]]), e("mask-radial-at-center", [["--tw-mask-radial-position", "center"]]), o("mask-radial-at", {
    ...
    supportsFractions: false,
    handle: (n) => [a("--tw-mask-radial-position", n)]
  }), o("mask-radial", {
    defaultValue: null,
    supportsNegative: false,
    supportsFractions: false,
    handle: (n) => [b2(), P2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))"), a("--tw-mask-radial-size", n)]
  }), k2("mask-radial-from", {
    color: (n) => [b2(), P2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), a("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), a("--tw-mask-radial-from-color", n)],
    position: (n) => [b2(), P2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), a("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), a("--tw-mask-radial-from-position", n)]
  }), k2("mask-radial-to", {
    color: (n) => [b2(), P2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), a("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), a("--tw-mask-radial-to-color", n)],
    position: (n) => [b2(), P2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), a("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), a("--tw-mask-radial-to-position", n)]
  });
  let L2 = () => D2([C2("--tw-mask-conic-position", "0deg"), C2("--tw-mask-conic-from-position", "0%"), C2("--tw-mask-conic-to-position", "100%"), C2("--tw-mask-conic-from-color", "black"), C2("--tw-mask-conic-to-color", "transparent")]);
  o("mask-conic", {
    defaultValue: null,
    supportsNegative: true,
    supportsFractions: false,
    ...
    handle: (n) => [b2(), L2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops, var(--tw-mask-conic-position)))"), a("--tw-mask-conic-position", n)]
  }), i("mask-conic", () => [{
    supportsNegative: true,
    values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
  }]), k2("mask-conic-from", {
    color: (n) => [b2(), L2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-conic-stops", "from var(--tw-mask-conic-position), var(--tw-mask-conic-from-color) var(--tw-mask-conic-from-position), var(--tw-mask-conic-to-color) var(--tw-mask-conic-to-position)"), a("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops))"), a("--tw-mask-conic-from-color", n)],
    position: (n) => [b2(), L2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-conic-stops", "from var(--tw-mask-conic-position), var(--tw-mask-conic-from-color) var(--tw-mask-conic-from-position), var(--tw-mask-conic-to-color) var(--tw-mask-conic-to-position)"), a("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops))"), a("--tw-mask-conic-from-position", n)]
  }), k2("mask-conic-to", {
  ...
  }]), e("stroke-none", [["stroke", "none"]]), t.functional("stroke", (n) => {
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
        switch (n.value.dataType ?? pe(c, ["color", "number", "length", "percentage"])) {
          case "number":
          case "length":
          case "percentage":
            return n.modifier ? void 0 : [a("stroke-width", c)];
          default:
            return c = Z2(n.value.value, n.modifier, r), c === null ? void 0 : [a("stroke", c)];
        }
      }
      {
        let c = Q2(n, r, ["--stroke", "--color"]);
  ...
  }]), e("object-contain", [["object-fit", "contain"]]), e("object-cover", [["object-fit", "cover"]]), e("object-fill", [["object-fit", "fill"]]), e("object-none", [["object-fit", "none"]]), e("object-scale-down", [["object-fit", "scale-down"]]), e("object-top", [["object-position", "top"]]), e("object-top-left", [["object-position", "left top"]]), e("object-top-right", [["object-position", "right top"]]), e("object-bottom", [["object-position", "bottom"]]), e("object-bottom-left", [["object-position", "left bottom"]]), e("object-bottom-right", [["object-position", "right bottom"]]), e("object-left", [["object-position", "left"]]), e("object-right", [["object-position", "right"]]), e("object-center", [["object-position", "center"]]), o("object", {
    themeKeys: ["--object-position"],
    handle: (n) => [a("object-position", n)]
  });
  for (let [n, c] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) l3(n, ["--padding", "--spacing"], (p2) => [a(c, p2)]);
  e("text-left", [["text-align", "left"]]), e("text-center", [["text-align", "center"]]), e("text-right", [["text-align", "right"]]), e("text-justify", [["text-align", "justify"]]), e("text-start", [["text-align", "start"]]), e("text-end", [["text-align", "end"]]), l3("indent", ["--text-indent", "--spacing"], (n) => [a("text-indent", n)], {
    supportsNegative: true
  }), e("align-baseline", [["vertical-align", "baseline"]]), e("align-top", [["vertical-align", "top"]]), e("align-middle", [["vertical-align", "middle"]]), e("align-bottom", [["vertical-align", "bottom"]]), e("align-text-top", [["vertical-align", "text-top"]]), e("align-text-bottom", [["vertical-align", "text-bottom"]]), e("align-sub", [["vertical-align", "sub"]]), e("align-super", [["vertical-align", "super"]]), o("align", {
    themeKeys: [],
    handle: (n) => [a("vertical-align", n)]
  }), t.functional("font", (n) => {
    if (!(!n.value || n.modifier)) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
        switch (n.value.dataType ?? pe(c, ["number", "generic-name", "family-name"])) {
          case "generic-name":
          case "family-name":
            return [a("font-family", c)];
          default:
            return [D2([C2("--tw-font-weight")]), a("--tw-font-weight", c), a("font-weight", c)];
        }
      }
      {
      ...
      }
      {
        ...
        if (c) return [D2([C2("--tw-font-weight")]), a("--tw-font-weight", c), a("font-weight", c)];
      }
    }
  }), i("font", () => [{
    values: [],
  ...
  }]), e("uppercase", [["text-transform", "uppercase"]]), e("lowercase", [["text-transform", "lowercase"]]), e("capitalize", [["text-transform", "capitalize"]]), e("normal-case", [["text-transform", "none"]]), e("italic", [["font-style", "italic"]]), e("not-italic", [["font-style", "normal"]]), e("underline", [["text-decoration-line", "underline"]]), e("overline", [["text-decoration-line", "overline"]]), e("line-through", [["text-decoration-line", "line-through"]]), e("no-underline", [["text-decoration-line", "none"]]), e("font-stretch-normal", [["font-stretch", "normal"]]), e("font-stretch-ultra-condensed", [["font-stretch", "ultra-condensed"]]), e("font-stretch-extra-condensed", [["font-stretch", "extra-condensed"]]), e("font-stretch-condensed", [["font-stretch", "condensed"]]), e("font-stretch-semi-condensed", [["font-stretch", "semi-condensed"]]), e("font-stretch-semi-expanded", [["font-stretch", "semi-expanded"]]), e("font-stretch-expanded", [["font-stretch", "expanded"]]), e("font-stretch-extra-expanded", [["font-stretch", "extra-expanded"]]), e("font-stretch-ultra-expanded", [["font-stretch", "ultra-expanded"]]), o("font-stretch", {
    handleBareValue: ({
      value: n
    }) => {
    ...
    handle: (n) => [a("font-stretch", n)]
  }), i("font-stretch", () => [{
    values: ["50%", "75%", "90%", "95%", "100%", "105%", "110%", "125%", "150%", "200%"]
  }]), s2("placeholder", {
    themeKeys: ["--background-color", "--color"],
    handle: (n) => [F2("&::placeholder", [a("--tw-sort", "placeholder-color"), a("color", n)])]
    ...
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
        switch (n.value.dataType ?? pe(c, ["color", "length", "percentage"])) {
          case "length":
          case "percentage":
            return n.modifier ? void 0 : [a("text-decoration-thickness", c)];
          default:
            return c = Z2(c, n.modifier, r), c === null ? void 0 : [a("text-decoration-color", c)];
        }
      }
      {
      ...
      {
        let c = Q2(n, r, ["--text-decoration-color", "--color"]);
  ...
  }]), e("animate-none", [["animation", "none"]]), o("animate", {
    themeKeys: ["--animate"],
    handle: (n) => [a("animation", n)]
  });
  {
    let n = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "), c = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" "), p2 = () => D2([C2("--tw-blur"), C2("--tw-brightness"), C2("--tw-contrast"), C2("--tw-grayscale"), C2("--tw-hue-rotate"), C2("--tw-invert"), C2("--tw-opacity"), C2("--tw-saturate"), C2("--tw-sepia"), C2("--tw-drop-shadow"), C2("--tw-drop-shadow-color"), C2("--tw-drop-shadow-alpha", "100%", "<percentage>"), C2("--tw-drop-shadow-size")]), x = () => D2([C2("--tw-backdrop-blur"), C2("--tw-backdrop-brightness"), C2("--tw-backdrop-contrast"), C2("--tw-backdrop-grayscale"), C2("--tw-backdrop-hue-rotate"), C2("--tw-backdrop-invert"), C2("--tw-backdrop-opacity"), C2("--tw-backdrop-saturate"), C2("--tw-backdrop-sepia")]);
    t.functional("filter", (y2) => {
      ...
      themeKeys: ["--blur"],
      handle: (y2) => [p2(), a("--tw-blur", `blur(${y2})`), a("filter", n)]
    }), e("blur-none", [p2, ["--tw-blur", " "], ["filter", n]]), o("backdrop-blur", {
      themeKeys: ["--backdrop-blur", "--blur"],
      handle: (y2) => [x(), a("--tw-backdrop-blur", `blur(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), e("backdrop-blur-none", [x, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", c], ["backdrop-filter", c]]), o("brightness", {
      themeKeys: ["--brightness"],
      handleBareValue: ({
        value: y2
      }) => p(y2) ? `${y2}%` : null,
      handle: (y2) => [p2(), a("--tw-brightness", `brightness(${y2})`), a("filter", n)]
    }), o("backdrop-brightness", {
      themeKeys: ["--backdrop-brightness", "--brightness"],
      handleBareValue: ({
        value: y2
      }) => p(y2) ? `${y2}%` : null,
      handle: (y2) => [x(), a("--tw-backdrop-brightness", `brightness(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("brightness", () => [{
      values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
      ...
      handle: (y2) => [p2(), a("--tw-contrast", `contrast(${y2})`), a("filter", n)]
    }), o("backdrop-contrast", {
      themeKeys: ["--backdrop-contrast", "--contrast"],
      handleBareValue: ({
        value: y2
      }) => p(y2) ? `${y2}%` : null,
      handle: (y2) => [x(), a("--tw-backdrop-contrast", `contrast(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("contrast", () => [{
      ...
      defaultValue: "100%",
      handle: (y2) => [p2(), a("--tw-grayscale", `grayscale(${y2})`), a("filter", n)]
      ...
      defaultValue: "100%",
      handle: (y2) => [x(), a("--tw-backdrop-grayscale", `grayscale(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("grayscale", () => [{
      ...
      handle: (y2) => [p2(), a("--tw-hue-rotate", `hue-rotate(${y2})`), a("filter", n)]
      ...
      handle: (y2) => [x(), a("--tw-backdrop-hue-rotate", `hue-rotate(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("hue-rotate", () => [{
      ...
      defaultValue: "100%",
      handle: (y2) => [p2(), a("--tw-invert", `invert(${y2})`), a("filter", n)]
    }), o("backdrop-invert", {
      ...
      defaultValue: "100%",
      handle: (y2) => [x(), a("--tw-backdrop-invert", `invert(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("invert", () => [{
      values: ["0", "25", "50", "75", "100"],
      ...
      handle: (y2) => [p2(), a("--tw-saturate", `saturate(${y2})`), a("filter", n)]
    }), o("backdrop-saturate", {
      themeKeys: ["--backdrop-saturate", "--saturate"],
      handleBareValue: ({
        value: y2
      }) => p(y2) ? `${y2}%` : null,
      handle: (y2) => [x(), a("--tw-backdrop-saturate", `saturate(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("saturate", () => [{
      ...
      defaultValue: "100%",
      handle: (y2) => [p2(), a("--tw-sepia", `sepia(${y2})`), a("filter", n)]
    }), o("backdrop-sepia", {
      ...
      defaultValue: "100%",
      handle: (y2) => [x(), a("--tw-backdrop-sepia", `sepia(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("sepia", () => [{
      values: ["0", "50", "100"],
      ...
      hasDefaultValue: true
    }]), e("drop-shadow-none", [p2, ["--tw-drop-shadow", " "], ["filter", n]]), t.functional("drop-shadow", (y2) => {
      let $2;
      if (y2.modifier && (y2.modifier.kind === "arbitrary" ? $2 = y2.modifier.value : p(y2.modifier.value) && ($2 = `${y2.modifier.value}%`)), !y2.value) {
        ...
        return K2 === null || N2 === null ? void 0 : [p2(), a("--tw-drop-shadow-alpha", $2), ...Be("--tw-drop-shadow-size", K2, $2, (V2) => `var(--tw-drop-shadow-color, ${V2})`), a("--tw-drop-shadow", g(N2, ",").map((V2) => `drop-shadow(${V2})`).join(" ")), a("filter", n)];
      }
      if (y2.value.kind === "arbitrary") {
        let K2 = y2.value.value;
        switch (y2.value.dataType ?? pe(K2, ["color"])) {
          case "color":
            return K2 = Z2(K2, y2.modifier, r), K2 === null ? void 0 : [p2(), a("--tw-drop-shadow-color", Y2(K2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
          default:
            return y2.modifier && !$2 ? void 0 : [p2(), a("--tw-drop-shadow-alpha", $2), ...Be("--tw-drop-shadow-size", K2, $2, (V2) => `var(--tw-drop-shadow-color, ${V2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)];
        }
      }
      {
        let K2 = r.get([`--drop-shadow-${y2.value.value}`]), N2 = r.resolve(y2.value.value, ["--drop-shadow"]);
        if (K2 && N2) return y2.modifier && !$2 ? void 0 : $2 ? [p2(), a("--tw-drop-shadow-alpha", $2), ...Be("--tw-drop-shadow-size", K2, $2, (V2) => `var(--tw-drop-shadow-color, ${V2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)] : [p2(), a("--tw-drop-shadow-alpha", $2), ...Be("--tw-drop-shadow-size", K2, $2, (V2) => `var(--tw-drop-shadow-color, ${V2})`), a("--tw-drop-shadow", g(N2, ",").map((V2) => `drop-shadow(${V2})`).join(" ")), a("filter", n)];
      }
      {
        let K2 = Q2(y2, r, ["--drop-shadow-color", "--color"]);
        if (K2) return [p2(), a("--tw-drop-shadow-color", Y2(K2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
      }
    }), i("drop-shadow", () => [{
      values: ["current", "inherit", "transparent"],
      ...
      handle: (y2) => [x(), a("--tw-backdrop-opacity", `opacity(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)]
    }), i("backdrop-opacity", () => [{
      values: Array.from({
        length: 21
      }, (y2, $2) => `${$2 * 5}`),
  ...
  }
  {
    ...
    e("transition-none", [["transition-property", "none"]]), e("transition-all", [["transition-property", "all"], ["transition-timing-function", n], ["transition-duration", c]]), e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", n], ["transition-duration", c]]), e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", n], ["transition-duration", c]]), e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", n], ["transition-duration", c]]), e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", n], ["transition-duration", c]]), o("transition", {
      ...
      handle: (p2) => [a("transition-property", p2), a("transition-timing-function", n), a("transition-duration", c)]
    }), e("transition-discrete", [["transition-behavior", "allow-discrete"]]), e("transition-normal", [["transition-behavior", "normal"]]), o("delay", {
      handleBareValue: ({
        value: p2
      }) => p(p2) ? `${p2}ms` : null,
      themeKeys: ["--transition-delay"],
      handle: (p2) => [a("transition-delay", p2)]
    });
    {
      let p2 = () => D2([C2("--tw-duration")]);
  ...
  {
    let n = () => D2([C2("--tw-ease")]);
    e("ease-initial", [n, ["--tw-ease", "initial"]]), e("ease-linear", [n, ["--tw-ease", "linear"], ["transition-timing-function", "linear"]]), o("ease", {
      themeKeys: ["--ease"],
      handle: (c) => [n(), a("--tw-ease", c), a("transition-timing-function", c)]
    });
  }
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), o("will-change", {
    themeKeys: [],
    handle: (n) => [a("will-change", n)]
  }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), o("content", {
    themeKeys: [],
    handle: (n) => [D2([C2("--tw-content", '""')]), a("--tw-content", n), a("content", "var(--tw-content)")]
  });
  {
    let n = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", c = () => D2([C2("--tw-contain-size"), C2("--tw-contain-layout"), C2("--tw-contain-paint"), C2("--tw-contain-style")]);
    e("contain-none", [["contain", "none"]]), e("contain-content", [["contain", "content"]]), e("contain-strict", [["contain", "strict"]]), e("contain-size", [c, ["--tw-contain-size", "size"], ["contain", n]]), e("contain-inline-size", [c, ["--tw-contain-size", "inline-size"], ["contain", n]]), e("contain-layout", [c, ["--tw-contain-layout", "layout"], ["contain", n]]), e("contain-paint", [c, ["--tw-contain-paint", "paint"], ["contain", n]]), e("contain-style", [c, ["--tw-contain-style", "style"], ["contain", n]]), o("contain", {
      themeKeys: [],
      handle: (p2) => [a("contain", p2)]
    });
  }
  e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => D2([C2("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), l3("leading", ["--leading", "--spacing"], (n) => [D2([C2("--tw-leading")]), a("--tw-leading", n), a("line-height", n)]), o("tracking", {
    supportsNegative: true,
    themeKeys: ["--tracking"],
    handle: (n) => [D2([C2("--tw-tracking")]), a("--tw-tracking", n), a("letter-spacing", n)]
  ...
  {
    let n = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", c = () => D2([C2("--tw-ordinal"), C2("--tw-slashed-zero"), C2("--tw-numeric-figure"), C2("--tw-numeric-spacing"), C2("--tw-numeric-fraction")]);
  ...
  {
    let n = () => D2([C2("--tw-outline-style", "solid")]);
    t.static("outline-hidden", () => [a("--tw-outline-style", "none"), a("outline-style", "none"), U2("@media", "(forced-colors: active)", [a("outline", "2px solid transparent"), a("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (c) => {
      if (c.value === null) {
      ...
      if (c.value.kind === "arbitrary") {
        ...
        switch (c.value.dataType ?? pe(p2, ["color", "length", "number", "percentage"])) {
          case "length":
          case "number":
          case "percentage":
            return c.modifier ? void 0 : [n(), a("outline-style", "var(--tw-outline-style)"), a("outline-width", p2)];
          default:
            return p2 = Z2(p2, c.modifier, r), p2 === null ? void 0 : [a("outline-color", p2)];
        }
      }
      {
        let p2 = Q2(c, r, ["--outline-color", "--color"]);
        if (p2) return [a("outline-color", p2)];
      }
      {
        if (c.modifier) return;
        let p2 = r.resolve(c.value.value, ["--outline-width"]);
  ...
  o("opacity", {
    ...
    handle: (n) => [a("opacity", n)]
  }), i("opacity", () => [{
    values: Array.from({
      length: 21
    }, (n, c) => `${c * 5}`),
    valueThemeKeys: ["--opacity"]
  }]), e("underline-offset-auto", [["text-underline-offset", "auto"]]), o("underline-offset", {
    supportsNegative: true,
    themeKeys: ["--text-underline-offset"],
    handleBareValue: ({
      value: n
    }) => p(n) ? `${n}px` : null,
    handle: (n) => [a("text-underline-offset", n)]
  }), i("underline-offset", () => [{
    supportsNegative: true,
    values: ["0", "1", "2", "4", "8"],
    ...
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
        switch (n.value.dataType ?? pe(c, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
          case "size":
          case "length":
          case "percentage":
          case "absolute-size":
          ...
          default:
            return c = Z2(c, n.modifier, r), c === null ? void 0 : [a("color", c)];
        }
      }
      {
        let c = Q2(n, r, ["--text-color", "--color"]);
  ...
  let R2 = () => D2([C2("--tw-text-shadow-color"), C2("--tw-text-shadow-alpha", "100%", "<percentage>")]);
  e("text-shadow-initial", [R2, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (n) => {
    ...
    if (n.modifier && (n.modifier.kind === "arbitrary" ? c = n.modifier.value : p(n.modifier.value) && (c = `${n.modifier.value}%`)), !n.value) {
      ...
      return p2 === null ? void 0 : [R2(), a("--tw-text-shadow-alpha", c), ...ne2("text-shadow", p2, c, (x) => `var(--tw-text-shadow-color, ${x})`)];
    }
    if (n.value.kind === "arbitrary") {
      let p2 = n.value.value;
      switch (n.value.dataType ?? pe(p2, ["color"])) {
        case "color":
          return p2 = Z2(p2, n.modifier, r), p2 === null ? void 0 : [R2(), a("--tw-text-shadow-color", Y2(p2, "var(--tw-text-shadow-alpha)"))];
        default:
          return [R2(), a("--tw-text-shadow-alpha", c), ...ne2("text-shadow", p2, c, (y2) => `var(--tw-text-shadow-color, ${y2})`)];
      }
    }
    ...
    }
    {
      ...
      if (p2) return [R2(), a("--tw-text-shadow-alpha", c), ...ne2("text-shadow", p2, c, (x) => `var(--tw-text-shadow-color, ${x})`)];
    }
    {
      let p2 = Q2(n, r, ["--text-shadow-color", "--color"]);
      if (p2) return [R2(), a("--tw-text-shadow-color", Y2(p2, "var(--tw-text-shadow-alpha)"))];
    }
  }), i("text-shadow", () => [{
    values: ["current", "inherit", "transparent"],
  ...
  }]);
  {
    ...
    var ve = y2, xt = $2;
    let n = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "), c = "0 0 #0000", p2 = () => D2([C2("--tw-shadow", c), C2("--tw-shadow-color"), C2("--tw-shadow-alpha", "100%", "<percentage>"), C2("--tw-inset-shadow", c), C2("--tw-inset-shadow-color"), C2("--tw-inset-shadow-alpha", "100%", "<percentage>"), C2("--tw-ring-color"), C2("--tw-ring-shadow", c), C2("--tw-inset-ring-color"), C2("--tw-inset-ring-shadow", c), C2("--tw-ring-inset"), C2("--tw-ring-offset-width", "0px", "<length>"), C2("--tw-ring-offset-color", "#fff"), C2("--tw-ring-offset-shadow", c)]);
    e("shadow-initial", [p2, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (N2) => {
      ...
      if (N2.modifier && (N2.modifier.kind === "arbitrary" ? V2 = N2.modifier.value : p(N2.modifier.value) && (V2 = `${N2.modifier.value}%`)), !N2.value) {
        let j2 = r.get(["--shadow"]);
        return j2 === null ? void 0 : [p2(), a("--tw-shadow-alpha", V2), ...ne2("--tw-shadow", j2, V2, (te2) => `var(--tw-shadow-color, ${te2})`), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let j2 = N2.value.value;
        switch (N2.value.dataType ?? pe(j2, ["color"])) {
          case "color":
            return j2 = Z2(j2, N2.modifier, r), j2 === null ? void 0 : [p2(), a("--tw-shadow-color", Y2(j2, "var(--tw-shadow-alpha)"))];
          default:
            return [p2(), a("--tw-shadow-alpha", V2), ...ne2("--tw-shadow", j2, V2, (et) => `var(--tw-shadow-color, ${et})`), a("box-shadow", n)];
        }
      }
      switch (N2.value.value) {
        case "none":
          return N2.modifier ? void 0 : [p2(), a("--tw-shadow", c), a("box-shadow", n)];
      }
      {
        let j2 = r.get([`--shadow-${N2.value.value}`]);
        if (j2) return [p2(), a("--tw-shadow-alpha", V2), ...ne2("--tw-shadow", j2, V2, (te2) => `var(--tw-shadow-color, ${te2})`), a("box-shadow", n)];
      }
      {
        let j2 = Q2(N2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [p2(), a("--tw-shadow-color", Y2(j2, "var(--tw-shadow-alpha)"))];
      }
    }), i("shadow", () => [{
      values: ["current", "inherit", "transparent"],
      ...
      hasDefaultValue: true
    }]), e("inset-shadow-initial", [p2, ["--tw-inset-shadow-color", "initial"]]), t.functional("inset-shadow", (N2) => {
      let V2;
      if (N2.modifier && (N2.modifier.kind === "arbitrary" ? V2 = N2.modifier.value : p(N2.modifier.value) && (V2 = `${N2.modifier.value}%`)), !N2.value) {
        let j2 = r.get(["--inset-shadow"]);
        return j2 === null ? void 0 : [p2(), a("--tw-inset-shadow-alpha", V2), ...ne2("--tw-inset-shadow", j2, V2, (te2) => `var(--tw-inset-shadow-color, ${te2})`), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let j2 = N2.value.value;
        switch (N2.value.dataType ?? pe(j2, ["color"])) {
          case "color":
            return j2 = Z2(j2, N2.modifier, r), j2 === null ? void 0 : [p2(), a("--tw-inset-shadow-color", Y2(j2, "var(--tw-inset-shadow-alpha)"))];
          default:
            return [p2(), a("--tw-inset-shadow-alpha", V2), ...ne2("--tw-inset-shadow", j2, V2, (et) => `var(--tw-inset-shadow-color, ${et})`, "inset "), a("box-shadow", n)];
        }
      }
      switch (N2.value.value) {
        case "none":
          return N2.modifier ? void 0 : [p2(), a("--tw-inset-shadow", c), a("box-shadow", n)];
      }
      {
        let j2 = r.get([`--inset-shadow-${N2.value.value}`]);
        if (j2) return [p2(), a("--tw-inset-shadow-alpha", V2), ...ne2("--tw-inset-shadow", j2, V2, (te2) => `var(--tw-inset-shadow-color, ${te2})`), a("box-shadow", n)];
      }
      {
        let j2 = Q2(N2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [p2(), a("--tw-inset-shadow-color", Y2(j2, "var(--tw-inset-shadow-alpha)"))];
      }
    }), i("inset-shadow", () => [{
      values: ["current", "inherit", "transparent"],
      valueThemeKeys: ["--box-shadow-color", "--color"],
      ...
      hasDefaultValue: true
    }]), e("ring-inset", [p2, ["--tw-ring-inset", "inset"]]);
    let x = r.get(["--default-ring-color"]) ?? "currentcolor";
    t.functional("ring", (N2) => {
      if (!N2.value) {
        if (N2.modifier) return;
        let V2 = r.get(["--default-ring-width"]) ?? "1px";
        return [p2(), a("--tw-ring-shadow", y2(V2)), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let V2 = N2.value.value;
        switch (N2.value.dataType ?? pe(V2, ["color", "length"])) {
          case "length":
            return N2.modifier ? void 0 : [p2(), a("--tw-ring-shadow", y2(V2)), a("box-shadow", n)];
          default:
            return V2 = Z2(V2, N2.modifier, r), V2 === null ? void 0 : [a("--tw-ring-color", V2)];
        }
      }
      {
        let V2 = Q2(N2, r, ["--ring-color", "--color"]);
        if (V2) return [a("--tw-ring-color", V2)];
      }
      {
        if (N2.modifier) return;
        let V2 = r.resolve(N2.value.value, ["--ring-width"]);
        if (V2 === null && p(N2.value.value) && (V2 = `${N2.value.value}px`), V2) return [p2(), a("--tw-ring-shadow", y2(V2)), a("box-shadow", n)];
      }
    }), i("ring", () => [{
      values: ["current", "inherit", "transparent"],
      ...
      hasDefaultValue: true
    }]), t.functional("inset-ring", (N2) => {
      if (!N2.value) return N2.modifier ? void 0 : [p2(), a("--tw-inset-ring-shadow", $2("1px")), a("box-shadow", n)];
      if (N2.value.kind === "arbitrary") {
        let V2 = N2.value.value;
        switch (N2.value.dataType ?? pe(V2, ["color", "length"])) {
          case "length":
            return N2.modifier ? void 0 : [p2(), a("--tw-inset-ring-shadow", $2(V2)), a("box-shadow", n)];
          default:
            return V2 = Z2(V2, N2.modifier, r), V2 === null ? void 0 : [a("--tw-inset-ring-color", V2)];
        }
      }
      {
        let V2 = Q2(N2, r, ["--ring-color", "--color"]);
      ...
      }
      {
        if (N2.modifier) return;
        let V2 = r.resolve(N2.value.value, ["--ring-width"]);
        if (V2 === null && p(N2.value.value) && (V2 = `${N2.value.value}px`), V2) return [p2(), a("--tw-inset-ring-shadow", $2(V2)), a("box-shadow", n)];
      }
    }), i("inset-ring", () => [{
      values: ["current", "inherit", "transparent"],
      valueThemeKeys: ["--ring-color", "--color"],
      ...
      if (N2.value) {
        if (N2.value.kind === "arbitrary") {
          ...
          switch (N2.value.dataType ?? pe(V2, ["color", "length"])) {
            ...
            default:
              return V2 = Z2(V2, N2.modifier, r), V2 === null ? void 0 : [a("--tw-ring-offset-color", V2)];
          }
        }
        {
        ...
        {
          let V2 = Q2(N2, r, ["--ring-offset-color", "--color"]);
  ...
  return si.test(t) ? (i) => {
    ...
    I2(r.nodes, (o) => {
      ...
      X2(s2, (l3) => {
        ...
        if (l3.value === "--spacing" && !(e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return X2(l3.nodes, (u2) => {
          if (u2.kind !== "function" || u2.value !== "--value" && u2.value !== "--modifier") return;
          let f2 = u2.value;
          for (let g2 of u2.nodes) if (g2.kind === "word") {
            if (g2.value === "integer") e[f2].usedSpacingInteger ||= true;
            else if (g2.value === "number" && (e[f2].usedSpacingNumber ||= true, e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return 2;
          }
        }), 0;
        if (l3.value !== "--value" && l3.value !== "--modifier") return;
        let d2 = g(H2(l3.nodes), ",");
...
`);
          let f2 = u2.value, g2 = structuredClone(l3), m = "¶";
          X2(g2.nodes, (A2, {
            replaceWith: b2
          }) => {
            A2.kind === "word" && A2.value === f2 && b2({
              kind: "word",
              value: m
            });
          });
          let h2 = "^".repeat(H2([u2]).length), v2 = H2([g2]).indexOf(m), w2 = ["```css", H2([l3]), " ".repeat(v2) + h2, "```"].join(`
`);
          console.warn(w2);
        }
      }), o.value = H2(s2);
      ...
      if (I2([s2], (w2, {
        ...
        if (A2?.kind !== "rule" && A2?.kind !== "at-rule" || w2.kind !== "declaration" || !w2.value) return;
        let k2 = G2(w2.value);
        (X2(k2, (S, {
          replaceWith: O2
        }) => {
          if (S.kind === "function") {
            if (S.value === "--value") {
              u2 = true;
              let P2 = Zt(l3, S, i);
              return P2 ? (f2 = true, P2.ratio ? v2 = true : h2.set(w2, A2), O2(P2.nodes), 1) : (u2 ||= false, b2([]), 2);
            } else if (S.value === "--modifier") {
              if (d2 === null) return b2([]), 2;
              g2 = true;
              let P2 = Zt(d2, S, i);
              return P2 ? (m = true, O2(P2.nodes), 1) : (g2 ||= false, b2([]), 2);
            }
          }
        }) ?? 0) === 0 && (w2.value = H2(k2));
      ...
      for (let [l3, {
        literals: d2,
        usedSpacingNumber: u2,
        usedSpacingInteger: f2,
        themeKeys: g2
      }] of [[o, e["--value"]], [s2, e["--modifier"]]]) {
        for (let m of d2) l3.push(m);
        if (u2) l3.push(...qe);
        else if (f2) for (let m of qe) p(m) && l3.push(m);
        for (let m of i.theme.keysInNamespaces(g2)) l3.push(m);
      }
      return [{
        values: o,
        modifiers: s2
...
function Zt(r, t, i) {
  for (let e of t.nodes) {
    ...
    if (r.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
      ...
      if (pe(r.value, [o]) !== null) return {
        nodes: G2(r.value)
      };
    }
  }
}
function ne2(r, t, i, e, o = "") {
  let s2 = false, l3 = Ve(t, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(Y2(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(Qt(u2, i))));
  function d2(u2) {
    return o ? g(u2, ",").map((f2) => o + f2).join(",") : u2;
  }
  return s2 ? [a(r, d2(Ve(t, e))), W2("@supports (color: lab(from red l a b))", [a(r, d2(l3))])] : [a(r, d2(l3))];
}
function Be(r, t, i, e, o = "") {
  let s2 = false, l3 = g(t, ",").map((d2) => Ve(d2, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(Y2(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(Qt(u2, i))))).map((d2) => `drop-shadow(${d2})`).join(" ");
  return s2 ? [a(r, o + g(t, ",").map((d2) => `drop-shadow(${Ve(d2, e)})`).join(" ")), W2("@supports (color: lab(from red l a b))", [a(r, o + l3)])] : [a(r, o + l3)];
}
var mt = {
  "--alpha": ui,
  "--spacing": fi,
...
function rr(r, t, i) {
  ...
  return X2(e, (o, {
    ...
    if (o.kind === "function" && o.value in mt) {
      let l3 = g(H2(o.nodes).trim(), ",").map((u2) => u2.trim()), d2 = mt[o.value](i, t, ...l3);
      return s2(G2(d2));
    }
  }), H2(e);
}
...
function Ge(r, t) {
  ...
  for (let s2 = 0; s2 < o; s2++) {
    ...
    if (l3 >= 48 && l3 <= 57 && d2 >= 48 && d2 <= 57) {
      ...
      for (l3 = r.charCodeAt(f2); l3 >= 48 && l3 <= 57; ) l3 = r.charCodeAt(++f2);
...
function ir(r) {
  ...
  for (let e of r.utilities.keys("functional")) {
    ...
    for (let s2 of o) for (let l3 of s2.values) {
      let d2 = l3 !== null && gi.test(l3), u2 = l3 === null ? e : `${e}-${l3}`;
      t.push({
        name: u2,
        utility: e,
        fraction: d2,
        modifiers: s2.modifiers
      }), s2.supportsNegative && t.push({
        name: `-${u2}`,
        utility: `-${e}`,
        fraction: d2,
        modifiers: s2.modifiers
...
function hi(r) {
  ...
  for (let l3 of r) {
    ...
    i || (i = {
      utility: d2,
      items: []
    }, e.set(d2, i)), d2 !== i.utility && (t.push(i), i = {
      utility: d2,
      items: []
    }, e.set(d2, i)), u2 ? o.get(d2).push(l3) : i.items.push(l3);
  }
  ...
  let s2 = [];
  for (let l3 of t) for (let d2 of l3.items) s2.push([d2.name, {
    modifiers: d2.modifiers
  }]);
  return s2;
}
function nr(r) {
  ...
  for (let [e, o] of r.variants.entries()) {
    let d2 = function({
      ...
      if (!m) return [];
      let h2 = F2(".__placeholder__", []);
      if (be(h2, m, r.variants) === null) return [];
      let v2 = [];
      return Me(h2.nodes, (w2, {
        path: A2
      }) => {
...
function or(r, t) {
  let {
    astNodes: i,
    nodeSorting: e
  } = ue2(Array.from(t), r), o = new Map(t.map((l3) => [l3, null])), s2 = 0n;
  for (let l3 of i) {
    let d2 = e.get(l3)?.candidate;
...
var gt = class {
  ...
  set(t, {
    ...
    d2 ? Object.assign(d2, {
      ...
      applyFn: e,
      compounds: o
    }) : (l3 === void 0 && (this.lastOrder = this.nextOrder(), l3 = this.lastOrder), this.variants.set(t, {
      kind: i,
      applyFn: e,
      order: l3,
      compoundsWith: s2,
...
function lr(r) {
  ...
  function i(f2, g2, {
    ...
    m = m ?? he(g2), t.static(f2, (h2) => {
      h2.nodes = g2.map((v2) => W2(v2, h2.nodes));
    }, {
      compounds: m
    });
  }
  ...
  function s2(f2) {
    for (let g2 of o) {
      ...
      let m = g(f2.params, ",");
      return m.length > 1 ? null : (m = e(f2.name, m), U2(f2.name, m.join(", ")));
    }
    return null;
  }
  function l3(f2) {
  ...
  t.compound("not", 3, (f2, g2) => {
    ...
    if (I2([f2], (h2, {
      ...
      return Object.assign(f2, F2("&", b2)), m = true, 1;
    ...
    let m = g2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group\\/${g2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group)`, h2 = false;
    if (I2([f2], (v2, {
      path: w2
    }) => {
    ...
    if (g2.variant.kind === "arbitrary" && g2.variant.relative) return null;
    let m = g2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer\\/${g2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer)`, h2 = false;
    if (I2([f2], (v2, {
      path: w2
    }) => {
      if (v2.kind !== "rule") return 0;
  ...
  {
    let f2 = function() {
      return D2([U2("@property", "--tw-content", [a("syntax", '"*"'), a("initial-value", '""'), a("inherits", "false")])]);
    };
    var d2 = f2;
    t.static("before", (g2) => {
      g2.nodes = [F2("&::before", [f2(), a("content", "var(--tw-content)"), ...g2.nodes])];
    }, {
      compounds: 0
    }), t.static("after", (g2) => {
      g2.nodes = [F2("&::after", [f2(), a("content", "var(--tw-content)"), ...g2.nodes])];
    }, {
      compounds: 0
    });
  }
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), i("user-valid", ["&:user-valid"]), i("user-invalid", ["&:user-invalid"]), i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (f2) => {
    f2.nodes = [F2("&:hover", [U2("@media", "(hover: hover)", f2.nodes)])];
    ...
    g2.value.kind === "arbitrary" ? f2.nodes = [F2(`&[aria-${ar(g2.value.value)}]`, f2.nodes)] : f2.nodes = [F2(`&[aria-${g2.value.value}="true"]`, f2.nodes)];
  }), t.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), t.functional("data", (f2, g2) => {
    if (!g2.value || g2.modifier) return null;
    f2.nodes = [F2(`&[data-${ar(g2.value.value)}]`, f2.nodes)];
  }), t.functional("nth", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [F2(`&:nth-child(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-last", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [F2(`&:nth-last-child(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-of-type", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [F2(`&:nth-of-type(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-last-of-type", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [F2(`&:nth-last-of-type(${g2.value.value})`, f2.nodes)];
    ...
    if (/^[\w-]*\s*\(/.test(m)) {
      ...
      f2.nodes = [U2("@supports", h2, f2.nodes)];
      return;
    }
    m.includes(":") || (m = `${m}: var(--tw)`), (m[0] !== "(" || m[m.length - 1] !== ")") && (m = `(${m})`), f2.nodes = [U2("@supports", m, f2.nodes)];
  }, {
    compounds: 1
  }), i("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), i("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), i("contrast-more", ["@media (prefers-contrast: more)"]), i("contrast-less", ["@media (prefers-contrast: less)"]);
  {
    let f2 = function(g2, m, h2, v2) {
      ...
      let A2 = v2.get(m);
      return A2 === null ? h2 === "asc" ? 1 : -1 : ge2(w2, A2, h2);
    };
    var u2 = f2;
    {
      let g2 = r.namespace("--breakpoint"), m = new q2((h2) => {
        switch (h2.kind) {
          case "static":
      ...
      t.group(() => {
        t.functional("max", (h2, v2) => {
          ...
          h2.nodes = [U2("@media", `(width < ${w2})`, h2.nodes)];
        }, {
          compounds: 1
        });
        ...
        for (let [h2, v2] of r.namespace("--breakpoint")) h2 !== null && t.static(h2, (w2) => {
          w2.nodes = [U2("@media", `(width >= ${v2})`, w2.nodes)];
        }, {
          compounds: 1
        });
    ...
    {
      let g2 = r.namespace("--container"), m = new q2((h2) => {
        switch (h2.kind) {
          case "functional": {
      ...
      t.group(() => {
        t.functional("@max", (h2, v2) => {
          let w2 = m.get(v2);
          if (w2 === null) return null;
          h2.nodes = [U2("@container", v2.modifier ? `${v2.modifier.value} (width < ${w2})` : `(width < ${w2})`, h2.nodes)];
        }, {
          compounds: 1
        });
      }, (h2, v2) => f2(h2, v2, "desc", m)), t.suggest("@max", () => Array.from(g2.keys()).filter((h2) => h2 !== null)), t.group(() => {
...
function ht(r, t) {
  I2(r, (i, {
    ...
    else if (i.kind === "at-rule" && (i.name === "@keyframes" || i.name === "@property")) return Object.assign(i, D2([U2(i.name, i.params, i.nodes)])), 1;
  });
}
function sr(r) {
  let t = Xt(r), i = lr(r), e = new q2((u2) => Jt(u2, d2)), o = new q2((u2) => Array.from(Gt(u2, d2))), s2 = new q2((u2) => {
    let f2 = ur(u2, d2);
    try {
      ke(f2.map(({
        node: g2
    ...
    candidatesToCss(u2) {
      ...
      for (let g2 of u2) {
        ...
        h2 = me(h2, d2, 0), h2.length === 0 || m ? f2.push(null) : f2.push(ee2(h2));
      }
      return f2;
    },
    getClassOrder(u2) {
    ...
    for (let g2 of u2) {
      ...
      if (m.length !== 0) {
        ...
        for (let {
          ...
          let w2 = 0n;
          for (let A2 of g2.variants) w2 |= 1n << BigInt(l3.get(A2));
          e.set(h2, {
            properties: v2,
            variants: w2,
            candidate: d2
...
function be(r, t, i, e = 0) {
  ...
  if (t.kind === "compound") {
    let l3 = U2("@slot");
    if (be(l3, t.variant, i, e + 1) === null || t.root === "not" && l3.nodes.length > 1) return null;
...
function vi(r, t) {
  ...
  let i = t.utilities.get(r.root) ?? [], e = [], o = i.filter((l3) => !fr(l3));
  for (let l3 of o) {
...
function wi(r) {
  ...
  for (; e.length > 0; ) {
    ...
    if (s2.kind === "declaration") {
      ...
      let l3 = vt.indexOf(s2.property);
      l3 !== -1 && t.add(l3);
    } else if (s2.kind === "rule" || s2.kind === "at-rule") for (let l3 of s2.nodes) e.push(l3);
  }
  return {
    order: Array.from(t).sort((s2, l3) => s2 - l3),
    count: i
  };
}
function Ee(r, t) {
  let i = 0, e = W2("&", r), o = /* @__PURE__ */ new Set(), s2 = new q2(() => /* @__PURE__ */ new Set()), l3 = new q2(() => /* @__PURE__ */ new Set());
  I2([e], (m, {
    parent: h2
  }) => {
    if (m.kind === "at-rule") {
      if (m.name === "@keyframes") return I2(m.nodes, (v2) => {
        if (v2.kind === "at-rule" && v2.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.");
      }), 1;
      if (m.name === "@utility") {
        let v2 = m.params.replace(/-\*$/, "");
        l3.get(v2).add(m), I2(m.nodes, (w2) => {
  ...
  function g2(m, h2 = []) {
    if (!d2.has(m)) {
      if (f2.has(m)) {
        ...
        throw m.kind === "at-rule" && m.name === "@utility" && v2.kind === "at-rule" && v2.name === "@utility" && I2(m.nodes, (w2) => {
...
${ee2([v2])}`);
      ...
      f2.add(m);
      for (let v2 of s2.get(m)) for (let w2 of l3.get(v2)) h2.push(m), g2(w2, h2), h2.pop();
  ...
  return __async(this, null, function* () {
    ...
    return I2(r, (l3, {
      ...
      if (l3.kind === "at-rule" && (l3.name === "@import" || l3.name === "@reference")) {
        ...
        let v2 = re2({}, []);
        return s2.push((() => __async(this, null, function* () {
          if (e > 100) throw new Error(`Exceeded maximum recursion depth while resolving \`${f2}\` in \`${t}\`)`);
          let w2 = yield i(f2, t), A2 = de2(w2.content);
          yield wt(A2, w2.base, i, e + 1), v2.nodes = ki([re2({
            base: w2.base
          }, A2)], g2, m, h2);
        }))()), d2(v2), 1;
      }
    }), s2.length > 0 && (yield Promise.all(s2)), o;
  });
}
function yi(r) {
...
function ki(r, t, i, e) {
  let o = r;
  return t !== null && (o = [U2("@layer", t, o)]), i !== null && (o = [U2("@media", i, o)]), e !== null && (o = [U2("@supports", e[0] === "(" ? e : `(${e})`, o)]), o;
}
...
function Re(r, t, i, e = []) {
  for (let o of t) if (o != null) for (let s2 of Reflect.ownKeys(o)) {
    ...
    l3 !== void 0 ? r[s2] = l3 : !Ae(r[s2]) || !Ae(o[s2]) ? r[s2] = o[s2] : r[s2] = Re({}, [r[s2], o[s2]], i, e), e.pop();
  }
  return r;
}
function Ze(r, t, i) {
  return function(o, s2) {
    ...
    let u2 = (() => {
      ...
      if (h2 !== null && typeof h2 == "object" && !Array.isArray(h2)) {
        ...
        for (let w2 in g2) w2 !== "__CSS_VALUES__" && (h2?.__CSS_VALUES__?.[w2] & 4 && gr(v2, w2.split("-")) !== void 0 || (v2[pe2(w2)] = g2[w2]));
        return v2;
      }
    ...
    return d2 && typeof u2 == "string" && (u2 = Y2(u2, d2)), u2 ?? s2;
  };
}
function $i(r, t) {
  ...
  for (let [g2, m] of s2) {
    if (!g2 || !g2.includes("--")) {
      e.set(g2, m), l3.set(g2, r.getOptions(g2 ? `--${i}-${g2}` : `--${i}`));
      continue;
    }
  ...
  for (let [g2, m] of o) {
    ...
    e.set(g2, [h2, v2]), l3.set(g2, [d2, w2]);
  }
  let u2 = {}, f2 = {};
  for (let [g2, m] of e) hr(u2, [g2 ?? "DEFAULT"], m);
  for (let [g2, m] of l3) hr(f2, [g2 ?? "DEFAULT"], m);
  return t[t.length - 1] === "DEFAULT" ? [u2?.DEFAULT ?? null, f2.DEFAULT ?? 0] : "DEFAULT" in u2 && Object.keys(u2).length === 1 ? [u2.DEFAULT, f2.DEFAULT ?? 0] : (u2.__CSS_VALUES__ = f2, [u2, f2]);
}
function gr(r, t) {
    ...
    switch (d2) {
      ...
      case Ar: {
        ...
        if (o = "", u2.value !== ":not" && u2.value !== ":where" && u2.value !== ":has" && u2.value !== ":is") {
          ...
          let m = l3;
          u2.nodes.push(Si(r.slice(f2, m))), o = "", l3 = m, e ? e.nodes.push(u2) : t.push(u2);
          break;
        }
      ...
      case xr: {
        ...
        o = "";
        let u2 = l3, f2 = 0;
        for (let g2 = l3 + 1; g2 < r.length; g2++) {
      ...
      case Ki: {
        let u2 = l3;
        for (let f2 = l3 + 1; f2 < r.length; f2++) if (s2 = r.charCodeAt(f2), s2 === vr) f2 += 1;
        else if (s2 === d2) {
          l3 = f2;
          break;
        }
...
function yt({
  ...
  let s2 = {
    addBase(l3) {
      if (o) return;
      let d2 = ie2(l3);
      e.current |= ke(d2, r), t.push(U2("@layer", "base", d2));
    },
    addVariant(l3, d2) {
      if (!Je.test(l3)) throw new Error(`\`addVariant('${l3}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
      typeof d2 == "string" || Array.isArray(d2) ? r.variants.static(l3, (u2) => {
        u2.nodes = Sr(d2, u2.nodes);
      }, {
        compounds: he(typeof d2 == "string" ? [d2] : d2)
      }) : typeof d2 == "object" && r.variants.fromAst(l3, ie2(d2));
    },
    matchVariant(l3, d2, u2) {
      function f2(m, h2, v2) {
        let w2 = d2(m, {
          modifier: h2?.value ?? null
        });
        return Sr(w2, v2);
      }
      let g2 = Object.keys(u2?.values ?? {});
      r.variants.group(() => {
        r.variants.functional(l3, (m, h2) => {
          if (!h2.value) {
          ...
          else if (h2.value.kind === "named" && u2?.values) {
        ...
        let v2 = m.value ? m.value.value : "DEFAULT", w2 = h2.value ? h2.value.value : "DEFAULT", A2 = u2?.values?.[v2] ?? v2, b2 = u2?.values?.[w2] ?? w2;
        if (u2 && typeof u2.sort == "function") return u2.sort({
          value: A2,
          modifier: m.modifier?.value ?? null
        }, {
          value: b2,
          modifier: h2.modifier?.value ?? null
        });
    ...
    addUtilities(l3) {
      ...
      let d2 = l3.flatMap((f2) => Object.entries(f2));
      d2 = d2.flatMap(([f2, g2]) => g(f2, ",").map((m) => [m.trim(), g2]));
      let u2 = new q2(() => []);
      for (let [f2, g2] of d2) {
        if (f2.startsWith("@keyframes ")) {
          o || t.push(W2(f2, ie2(g2)));
          continue;
        }
        ...
        if (Oe(m, (v2) => {
          if (v2.kind === "selector" && v2.value[0] === "." && Tr.test(v2.value.slice(1))) {
            let w2 = v2.value;
            v2.value = "&";
            let A2 = Pe(m), b2 = w2.slice(1), k2 = A2 === "&" ? ie2(g2) : [W2(A2, ie2(g2))];
      ...
      for (let [f2, g2] of u2) r.theme.prefix && I2(g2, (m) => {
        if (m.kind === "rule") {
    ...
    matchUtilities(l3, d2) {
      let u2 = d2?.type ? Array.isArray(d2?.type) ? d2.type : [d2.type] : ["any"];
      for (let [g2, m] of Object.entries(l3)) {
        let h2 = function({
          negative: v2
        }) {
          return (w2) => {
            if (w2.value?.kind === "arbitrary" && u2.length > 0 && !u2.includes("any") && (w2.value.dataType && !u2.includes(w2.value.dataType) || !w2.value.dataType && !pe(w2.value.value, u2))) return;
            let A2 = u2.includes("color"), b2 = null, k2 = false;
            {
              ...
              A2 && (O2 = Object.assign({
                ...
                transparent: "transparent",
                current: "currentcolor"
              }, O2)), w2.value ? w2.value.kind === "arbitrary" ? b2 = w2.value.value : w2.value.fraction && O2[w2.value.fraction] ? (b2 = O2[w2.value.fraction], k2 = true) : O2[w2.value.value] ? b2 = O2[w2.value.value] : O2.__BARE_VALUE__ && (b2 = O2.__BARE_VALUE__(w2.value) ?? null, k2 = (w2.value.fraction !== null && b2?.includes("/")) ?? false) : b2 = O2.DEFAULT ?? null;
            }
            if (b2 === null) return;
            let T2;
            {
              let O2 = d2?.modifiers ?? null;
              w2.modifier ? O2 === "any" || w2.modifier.kind === "arbitrary" ? T2 = w2.modifier.value : O2?.[w2.modifier.value] ? T2 = O2[w2.modifier.value] : A2 && !Number.isNaN(Number(w2.modifier.value)) ? T2 = `${w2.modifier.value}%` : T2 = null : T2 = null;
            }
            if (w2.modifier && T2 === null && !k2) return w2.value?.kind === "arbitrary" ? null : void 0;
            A2 && T2 !== null && (b2 = Y2(b2, T2)), v2 && (b2 = `calc(${b2} * -1)`);
            let S = ie2(m(b2, {
              modifier: T2
            }));
        ...
        d2?.supportsNegativeValues && r.utilities.functional(`-${g2}`, h2({
          negative: true
        }), {
          types: u2
        }), r.utilities.functional(g2, h2({
          negative: false
        }), {
          types: u2
        }), r.utilities.suggest(g2, () => {
          let v2 = d2?.values ?? {}, w2 = new Set(Object.keys(v2));
          w2.delete("__BARE_VALUE__"), w2.has("DEFAULT") && (w2.delete("DEFAULT"), w2.add(null));
          let A2 = d2?.modifiers ?? {}, b2 = A2 === "any" ? [] : Object.keys(A2);
          return [{
            supportsNegative: d2?.supportsNegativeValues ?? false,
            values: Array.from(w2),
            modifiers: b2
          }];
        });
      }
...
function ie2(r) {
  ...
  for (let [e, o] of i) if (typeof o != "object") {
    ...
    t.push(a(e, String(o)));
  } else if (Array.isArray(o)) for (let s2 of o) typeof s2 == "string" ? t.push(a(e, s2)) : t.push(W2(e, ie2(s2)));
  else o !== null && t.push(W2(e, ie2(o)));
  return t;
}
function Sr(r, t) {
  return (typeof r == "string" ? [r] : r).flatMap((e) => {
    if (e.trim().endsWith("}")) {
      let o = e.replace("}", "{@slot}}"), s2 = de2(o);
      return ht(s2, t), s2;
    } else return W2(e, t);
  });
}
...
function Di(r) {
  let t = [];
  if ("keyframes" in r.theme) for (let [i, e] of Object.entries(r.theme.keyframes)) t.push(U2("@keyframes", i, ie2(e)));
  return t;
}
function Kr(r) {
  return {
    theme: __spreadProps(__spreadValues({}, ye), {
      colors: ({
        theme: t
      }) => t("color", {}),
      extend: {
        fontSize: ({
          theme: t
        }) => __spreadValues({}, t("text", {})),
        boxShadow: ({
          theme: t
        }) => __spreadValues({}, t("shadow", {})),
        animation: ({
          theme: t
        }) => __spreadValues({}, t("animate", {})),
        aspectRatio: ({
          theme: t
        }) => __spreadValues({}, t("aspect", {})),
        borderRadius: ({
          theme: t
        }) => __spreadValues({}, t("radius", {})),
        screens: ({
          theme: t
        }) => __spreadValues({}, t("breakpoint", {})),
        letterSpacing: ({
          theme: t
        }) => __spreadValues({}, t("tracking", {})),
        lineHeight: ({
          theme: t
        }) => __spreadValues({}, t("leading", {})),
        transitionDuration: {
          DEFAULT: r.get(["--default-transition-duration"]) ?? null
        },
        transitionTimingFunction: {
          DEFAULT: r.get(["--default-transition-timing-function"]) ?? null
        },
        maxWidth: ({
          theme: t
        }) => __spreadValues({}, t("container", {}))
      }
    })
  };
}
...
function bt(r, t) {
  ...
  let e = Fi(i);
  return {
    resolvedConfig: __spreadProps(__spreadValues({}, i.result), {
      content: i.content,
      theme: i.theme,
      plugins: i.plugins
    }),
...
function kt(r, {
  ...
  let s2 = [];
  for (let u2 of t.plugins ?? []) "__isOptionsFunction" in u2 ? s2.push(__spreadProps(__spreadValues({}, u2()), {
    reference: o
  })) : "handler" in u2 ? s2.push(__spreadProps(__spreadValues({}, u2), {
    reference: o
  })) : s2.push({
    handler: u2,
    reference: o
  ...
  for (let u2 of t.presets ?? []) kt(r, {
    path: e,
    base: i,
    config: u2,
    reference: o
  });
  for (let u2 of s2) r.plugins.push(u2), u2.config && kt(r, {
    path: e,
    base: i,
    config: u2.config,
  ...
  for (let u2 of d2) r.content.files.push(typeof u2 == "object" ? u2 : {
    base: i,
    pattern: u2
  });
  r.configs.push(t);
...
function Fi(r) {
  let t = /* @__PURE__ */ new Set(), i = Ze(r.design, () => r.theme, o), e = Object.assign(i, {
    theme: i,
    colors: l
  });
  function o(s2) {
  ...
  for (let s2 of r.configs) {
    ...
    for (let u2 in d2) r.extend[u2] ??= [], r.extend[u2].push(d2[u2]);
  }
...
function _r(r, t) {
  ...
  for (let [l3, d2] of Object.entries(i)) {
    let h2 = function(v2) {
      t.variants.static(l3, (w2) => {
        w2.nodes = [U2("@media", m, w2.nodes)];
      }, {
        order: v2
      });
    };
    var s2 = h2;
    let u2 = t.variants.get(l3), f2 = t.theme.resolveValue(l3, ["--breakpoint"]);
    if (u2 && f2 && !t.theme.hasDefault(`--breakpoint-${l3}`)) continue;
    let g2 = true;
...
function Li(r) {
  return (Array.isArray(r) ? r : [r]).map((i) => typeof i == "string" ? {
    min: i
...
function Dr(r, t) {
  ...
  if (Object.keys(i).length > 0) {
    let s2 = t.variants.get("aria"), l3 = s2?.applyFn, d2 = s2?.compounds;
    t.variants.functional("aria", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in i ? l3?.(u2, __spreadProps(__spreadValues({}, f2), {
        value: {
          kind: "arbitrary",
          value: i[g2.value]
        }
  ...
  if (Object.keys(e).length > 0) {
    let s2 = t.variants.get("supports"), l3 = s2?.applyFn, d2 = s2?.compounds;
    t.variants.functional("supports", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in e ? l3?.(u2, __spreadProps(__spreadValues({}, f2), {
        value: {
          kind: "arbitrary",
          value: e[g2.value]
        }
  ...
  if (Object.keys(o).length > 0) {
    let s2 = t.variants.get("data"), l3 = s2?.applyFn, d2 = s2?.compounds;
    t.variants.functional("data", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in o ? l3?.(u2, __spreadProps(__spreadValues({}, f2), {
        value: {
          kind: "arbitrary",
          value: o[g2.value]
        }
...
\`@plugin\` options must be a flat list of declarations.`);
            ...
            let T2 = k2.value, S = g(T2, ",").map((O2) => {
              ...
              if (Number.isNaN(Number(O2))) {
                ...
                if (O2[0] === "{" && O2[O2.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${ee2([k2]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
          ...
          l3.push([{
            id: A2,
            base: w2.base,
            reference: !!w2.reference
          }, Object.keys(b2).length > 0 ? b2 : null]), v2([]), s2 |= 4;
          return;
        }
        if (m.name === "@config") {
    ...
    if (r.resolveThemeValue = function(h2, v2) {
      return h2.startsWith("--") ? u2(h2, v2) : (s2 |= Ur({
        designSystem: r,
        base: t,
        ast: i,
        sources: o,
        configs: [],
        pluginDetails: []
      }), r.resolveThemeValue(h2, v2));
    }, !l3.length && !d2.length) return 0;
    let [f2, g2] = yield Promise.all([Promise.all(d2.map((_02) => __async(this, [_02], function* ({
      id: m,
      base: h2,
      reference: v2
    }) {
      let w2 = yield e(m, h2, "config");
      return {
        path: m,
        base: w2.base,
        config: w2.module,
    ...
    }))), Promise.all(l3.map((_02) => __async(this, [_02], function* ([{
      id: m,
      base: h2,
      reference: v2
    }, w2]) {
      let A2 = yield e(m, h2, "plugin");
      return {
        path: m,
        base: A2.base,
        plugin: A2.module,
...
function Ur({
  ...
  let l3 = 0, u2 = [...s2.map((b2) => {
    if (!b2.options) return {
      config: {
        plugins: [b2.plugin]
      },
      base: b2.base,
    ...
    if ("__isOptionsFunction" in b2.plugin) return {
      config: {
        plugins: [b2.plugin(b2.options)]
      },
      base: b2.base,
      reference: b2.reference
    };
    ...
    resolvedConfig: g2,
    replacedThemeKeys: m
  } = bt(r, u2), h2 = r.resolveThemeValue;
  ...
  }, w2 = yt(__spreadProps(__spreadValues({}, v2), {
    referenceMode: false
  })), A2;
  for (let {
    handler: b2,
    reference: k2
  } of f2.plugins) k2 ? (A2 ||= yt(__spreadProps(__spreadValues({}, v2), {
    referenceMode: true
  })), b2(A2)) : b2(w2);
  if (pr(r, g2, m), Rr(r, g2, m), Dr(g2, r), _r(g2, r), Or(g2, r), !r.theme.prefix && f2.prefix) {
  ...
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    ...
    I2(i, (k2, {
      ...
      if (k2.kind === "at-rule" && !(k2.name !== "@tailwind" || k2.params !== "utilities")) return S?.kind === "rule" && S.selector === b2 ? 2 : (T2(F2(b2, [k2])), 2);
    });
  }
...
This feature is not currently supported.`);
    let k2 = false;
    b2.pattern[0] == "!" && (k2 = true, b2.pattern = b2.pattern.slice(1)), e.push(__spreadProps(__spreadValues({}, b2), {
      negated: k2
    }));
  }
  return l3;
...
function Xe(r) {
  ...
  let d2 = o.slice(1, l3), u2 = o.slice(l3 + 1), f2;
  Wi(d2) ? f2 = Bi(d2) : f2 = g(d2, ","), f2 = f2.flatMap((m) => Xe(m));
  let g2 = Xe(u2);
  for (let m of g2) for (let h2 of f2) i.push(e + h2 + m);
  return i;
}
function Wi(r) {
  return Fr.test(r);
...
var qi = /^[a-z]+$/;
var st = ((o) => (o[o.None = 0] = "None", o[o.AtProperty = 1] = "AtProperty", o[o.ColorMix = 2] = "ColorMix", o[o.All = 3] = "All", o))(st || {});
function Gi() {
...
function zr(_0) {
  return __async(this, arguments, function* (r, {
    ...
    let s2 = null, l3 = new ze(), d2 = [], u2 = [], f2 = null, g2 = null, m = [], h2 = [], v2 = [], w2 = [], A2 = null;
    I2(r, (k2, {
      parent: T2,
      replaceWith: S,
      context: O2
      ...
      if (k2.kind === "at-rule") {
        if (k2.name === "@tailwind" && (k2.params === "utilities" || k2.params.startsWith("utilities"))) {
          ...
          for (let L2 of P2) if (L2.startsWith("source(")) {
            ...
            A2 = {
              base: O2.sourceBase ?? O2.base,
              pattern: R2.slice(1, -1)
            };
          }
          g2 = k2, o |= 16;
        }
        ...
        if (k2.name === "@variant" && (T2 === null ? k2.nodes.length === 0 ? k2.name = "@custom-variant" : (I2(k2.nodes, (P2) => {
          ...
          if (k2.nodes.length === 0) {
            ...
            d2.push((B2) => {
              B2.variants.static(P2, (oe) => {
                let ve = [];
                z2.length > 0 && ve.push(F2(z2.join(", "), oe.nodes));
                for (let xt of J2) ve.push(W2(xt, oe.nodes));
                oe.nodes = ve;
              }, {
                compounds: he([...z2, ...J2])
              });
        ...
        if (k2.name === "@media") {
          ...
          for (let R2 of P2) if (R2.startsWith("source(")) {
            ...
            I2(k2.nodes, (z2, {
              ...
              if (z2.kind === "at-rule" && z2.name === "@tailwind" && z2.params === "utilities") return z2.params += ` source(${J2})`, B2([re2({
                sourceBase: O2.base
              }, [z2])]), 2;
            });
          ...
          } else R2 === "important" ? s2 = true : R2 === "reference" ? k2.nodes = [re2({
            reference: true
          }, k2.nodes)] : L2.push(R2);
        ...
        if (k2.name === "@theme") {
          ...
          return I2(k2.nodes, (R2) => {
            if (R2.kind === "at-rule" && R2.name === "@keyframes") return l3.addKeyframes(R2), 1;
            if (R2.kind === "comment") return;
            if (R2.kind === "declaration" && R2.property.startsWith("--")) {
              l3.add(pe2(R2.property), R2.value ?? "", P2);
              return;
            }
            let J2 = ee2([U2(k2.name, k2.params, [R2])]).split(`
`).map((z2, B2, oe) => `${B2 === 0 || B2 >= oe.length - 2 ? " " : ">"} ${z2}`).join(`
`);
            throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${J2}`);
          }), f2 ? S([]) : (f2 = F2(":root, :host", []), S([f2])), 1;
        }
      }
    });
    let b2 = sr(l3);
    ...
    if (m.length > 0) {
      for (let k2 of m) {
        let T2 = F2("&", k2.nodes), S = k2.params, O2 = b2.parseVariant(S);
    ...
    return o |= ke(r, b2), o |= Ee(r, b2), I2(r, (k2, {
      replaceWith: T2
    }) => {
...
function Hi(_0) {
  return __async(this, arguments, function* (r, t = {}) {
    let {
      designSystem: i,
      ast: e,
      sources: o,
    ...
    return {
      ...
      build(w2) {
        if (d2 === 0) return r;
        if (!l3) return m ??= me(e, i, t.polyfills), m;
        let A2 = v2, b2 = false;
        v2 = false;
        let k2 = g2.size;
        for (let S of w2) if (!i.invalidCandidates.has(S)) if (S[0] === "-" && S[1] === "-") {
          ...
          A2 ||= O2, b2 ||= O2;
        } else g2.add(S), A2 ||= g2.size !== k2;
        if (!A2) return m ??= me(e, i, t.polyfills), m;
        let T2 = ue2(g2, i, {
          onInvalidCandidate: f2
        }).astNodes;
        return !b2 && h2 === T2.length ? (m ??= me(e, i, t.polyfills), m) : (h2 = T2.length, l3.nodes = T2, m = me(e, i, t.polyfills), m);
      }
    };
  });
}
function Xa(_0) {
  return __async(this, arguments, function* (r, t = {}) {
    let i = de2(r), e = yield Hi(i, t), o = i, s2 = r;
    return __spreadProps(__spreadValues({}, e), {
      build(l3) {
        let d2 = e.build(l3);
        return d2 === o || (s2 = ee2(d2), o = d2), s2;
      }
    });
  });
}
function el(_0) {
  return __async(this, arguments, function* (r, t = {}) {
    return (yield zr(de2(r), t)).designSystem;
  });
}
function Zi() {
